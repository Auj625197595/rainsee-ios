...
var braveTarget: PackageDescription.Target = .target(
  ...
  resources: [
    ...
    .copy("Assets/ablock/afalakplffnnnlkncjhbmahjfjhmlkal"),
    .copy("Assets/ablock/aoojcmojmmcbpfgoecoadbdpnagfchel"),
    .copy("Assets/ablock/gkboaolpopklhgplhaaiboijnklogmbc"),
    .copy("Assets/ablock/jdemghhogofbaojeemgolooebimdfcea"),
    .copy("Assets/ablock/mfddibmblmbccpadfndgakiopmmhebop"),

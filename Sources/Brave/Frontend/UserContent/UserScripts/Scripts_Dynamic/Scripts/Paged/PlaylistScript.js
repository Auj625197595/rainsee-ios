...
window.__firefox__.includeOnce("Playlist", function($) {
  ...
  let whiteList = [
      {"id":"3","skey":"wap.sogou.com\/web\/sl","type":"1"},
      {"id":"5","skey":"pcvideoaliyun.titan.mgtv.com","type":"1"},
      {"id":"6","skey":"titan.mgtv.com","type":"1"},
      {"id":"8","skey":"cibntv.net","type":"1"},
      {"id":"9","skey":"youku.com","type":"1"},
      {"id":"13","skey":"inter.71edge.com","type":"1"},
      {"id":"14","skey":"video.iqiyi.com","type":"1"},
      {"id":"15","skey":"m.iqiyi.com","type":"1"},
      {"id":"16","skey":"m.baidu.com\/s","type":"1"},
      {"id":"17","skey":"yz.m.sm.cn\/s","type":"1"},
      {"id":"18","skey":"new1cloud.com","type":"1"},
      {"id":"19","skey":"xmcdn.com","type":"1"},
      {"id":"20","skey":"&c=MWEB&","type":"1"},
      {"id":"21","skey":"www.youtube.com\/s\/search\/audio","type":"1"},
      {"id":"22","skey":"cntv.myhwcdn.cn","type":"1"},
      {"id":"23","skey":"cntv.myalicdn.com","type":"1"},
      {"id":"24","skey":"cntv.qcloudcdn.com","type":"1"},
      {"id":"26","skey":"112.1.130","type":"1"},
      {"id":"27","skey":"115.231.130","type":"1"},
      {"id":"28","skey":"-adaptive.akamaized.net\/exp","type":"1"},
      {"id":"30","skey":".m4s","type":"1"},
      {"id":"31","skey":"gstatic.com\/video","type":"1"},
      {"id":"32","skey":"v3-xgwap.ixigua.com","type":"1"},
      {"id":"33","skey":"b-hls-17.doppiocdn.com\/hls","type":"1"},
      {"skey":"ltsgdty.gtimg.com"},
      {"skey":".tc.qq.com"}
      ];
    ...
    $(function() {
      ...
      var url = node.src;
        for(var i=0;i<whiteList.length;i++){
            if(url.indexOf(whiteList[i].skey)>-1){
                console.log("触发嗅探白名单",whiteList[i].skey);
                return;
            }
        }

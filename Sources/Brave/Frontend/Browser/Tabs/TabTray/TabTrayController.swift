...
class TabTrayController: AuthenticationController {
  ...
  deinit {
    ...
    override func viewDidLoad() {
        ...
        // 设置为 true，以便正确定义呈现上下文。
        definesPresentationContext = true

        // 创建并配置搜索栏视图，使用 "then" 函数来简化配置。
        ...
        // 设置 TabSyncView 的操作处理程序，用于呈现同步设置。

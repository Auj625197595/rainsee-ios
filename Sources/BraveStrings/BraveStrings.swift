...
public extension Strings {
    static let cancelButtonTitle = NSLocalizedString("CancelButtonTitle", tableName: "BraveShared", bundle: .module, value: "Cancel", comment: "")
    static let unlockButtonTitle = NSLocalizedString("UnlockButtonTitle", tableName: "BraveShared", bundle: .module, value: "Unlock", comment: "")
    static let webContentAccessibilityLabel = NSLocalizedString("WebContentAccessibilityLabel", tableName: "BraveShared", bundle: .module, value: "Web content", comment: "Accessibility label for the main web content view")
    static let shareLinkActionTitle = NSLocalizedString("ShareLinkActionTitle", tableName: "BraveShared", bundle: .module, value: "Share Link", comment: "Context menu item for sharing a link URL")
    static let showTabs = NSLocalizedString("ShowTabs", tableName: "BraveShared", bundle: .module, value: "Show Tabs", comment: "Accessibility Label for the tabs button in the browser toolbar")
    static let copyLinkActionTitle = NSLocalizedString("CopyLinkActionTitle", tableName: "BraveShared", bundle: .module, value: "Copy Link", comment: "Context menu item for copying a link URL to the clipboard")
    static let openNewPrivateTabButtonTitle = NSLocalizedString("OpenNewPrivateTabButtonTitle", tableName: "BraveShared", bundle: .module, value: "Open in New Private Tab", comment: "Context menu option for opening a link in a new private tab")
    static let deleteLoginButtonTitle = NSLocalizedString("DeleteLoginButtonTitle", tableName: "BraveShared", bundle: .module, value: "Delete", comment: "Label for the button used to delete the current login.")
    static let saveButtonTitle = NSLocalizedString("SaveButtonTitle", tableName: "BraveShared", bundle: .module, value: "Save", comment: "Label for the button used to save data")
    static let share = NSLocalizedString("CommonShare", tableName: "BraveShared", bundle: .module, value: "Share", comment: "Text to select sharing something (example: image, video, URL)")
    static let download = NSLocalizedString("CommonDownload", tableName: "BraveShared", bundle: .module, value: "Download", comment: "Text to choose for downloading a file (example: saving an image to phone)")
    static let showLinkPreviewsActionTitle = NSLocalizedString("ShowLinkPreviewsActionTitle", tableName: "BraveShared", bundle: .module, value: "Show Link Previews", comment: "Context menu item for showing link previews")
    static let hideLinkPreviewsActionTitle = NSLocalizedString("HideLinkPreviewsActionTitle", tableName: "BraveShared", bundle: .module, value: "Hide Link Previews", comment: "Context menu item for hiding link previews")
...
public extension Strings {
    static let sendCrashReportAlertTitle = NSLocalizedString("SendCrashReportAlertTitle", tableName: "BraveShared", bundle: .module, value: "Oops! Browser crashed", comment: "Title for prompt displayed to user after the app crashes")
    static let sendCrashReportAlertMessage = NSLocalizedString("SendCrashReportAlertMessage", tableName: "BraveShared", bundle: .module, value: "Send a crash report so Rainsee can fix the problem?", comment: "Message displayed in the crash dialog above the buttons used to select when sending reports")
    static let sendReportButtonTitle = NSLocalizedString("SendReportButtonTitle", tableName: "BraveShared", bundle: .module, value: "Send Report", comment: "Used as a button label for crash dialog prompt")
    static let alwaysSendButtonTitle = NSLocalizedString("AlwaysSendButtonTitle", tableName: "BraveShared", bundle: .module, value: "Always Send", comment: "Used as a button label for crash dialog prompt")
    static let dontSendButtonTitle = NSLocalizedString("DontSendButtonTitle", tableName: "BraveShared", bundle: .module, value: "Don’t Send", comment: "Used as a button label for crash dialog prompt")
    static let restoreTabOnCrashAlertTitle = NSLocalizedString("RestoreTabOnCrashAlertTitle", tableName: "BraveShared", bundle: .module, value: "Browser Closed Unexpectedly.", comment: "Restore Tabs Prompt Title")
    static let restoreTabOnCrashAlertMessage = NSLocalizedString("RestoreTabOnCrashAlertMessage", tableName: "BraveShared", bundle: .module, value: "Unfortunately, Browser crashed or did not close properly.\nRestore your tabs?", comment: "Restore Tabs Prompt Description")
    static let restoreTabNegativeButtonTitle = NSLocalizedString("RestoreTabNegativeButtonTitle", tableName: "BraveShared", bundle: .module, value: "No", comment: "Restore Tabs Negative Action")
    static let restoreTabAffirmativeButtonTitle = NSLocalizedString("RestoreTabAffirmativeButtonTitle", tableName: "BraveShared", bundle: .module, value: "Yes", comment: "Restore Tabs Affirmative Action")
    static let clearPrivateDataAlertCancelButtonTitle = NSLocalizedString("ClearPrivateDataAlertCancelButtonTitle", tableName: "BraveShared", bundle: .module, value: "Cancel", comment: "The cancel button when confirming clear private data.")
    static let clearPrivateDataAlertOkButtonTitle = NSLocalizedString("ClearPrivateDataAlertOkButtonTitle", tableName: "BraveShared", bundle: .module, value: "OK", comment: "The button that clears private data.")
    static let clearSyncedHistoryAlertMessage = NSLocalizedString("ClearSyncedHistoryAlertMessage", tableName: "BraveShared", bundle: .module, value: "This action will clear all of your private data, including history from your synced devices.", comment: "Description of the confirmation dialog shown when a user tries to clear history that's synced to another device.")
    static let clearSyncedHistoryAlertCancelButtoTitle = NSLocalizedString("ClearSyncedHistoryAlertCancelButtoTitle", tableName: "BraveShared", bundle: .module, value: "Cancel", comment: "The cancel button when confirming clear history.")
    static let clearSyncedHistoryAlertOkButtoTitle = NSLocalizedString("ClearSyncedHistoryAlertOkButtoTitle", tableName: "BraveShared", bundle: .module, value: "OK", comment: "The confirmation button that clears history even when Sync is connected.")
    static let deleteLoginAlertTitle = NSLocalizedString("DeleteLoginAlertTitle", tableName: "BraveShared", bundle: .module, value: "Are you sure?", comment: "Prompt title when deleting logins")
    static let deleteLoginAlertLocalMessage = NSLocalizedString("DeleteLoginAlertLocalMessage", tableName: "BraveShared", bundle: .module, value: "Logins will be permanently removed.", comment: "Prompt message warning the user that deleting non-synced logins will permanently remove them")
    static let deleteLoginAlertSyncedDevicesMessage = NSLocalizedString("DeleteLoginAlertSyncedDevicesMessage", tableName: "BraveShared", bundle: .module, value: "Logins will be removed from all connected devices.", comment: "Prompt message warning the user that deleted logins will remove logins from all connected devices")
    static let deleteLoginAlertCancelActionTitle = NSLocalizedString("DeleteLoginAlertCancelActionTitle", tableName: "BraveShared", bundle: .module, value: "Cancel", comment: "Prompt option for cancelling out of deletion")
    static let genericErrorTitle = NSLocalizedString(
        "genericErrorTitle", tableName: "BraveShared",
        bundle: .module, value: "Error", comment: "")
    static let genericErrorBody = NSLocalizedString(
...
public extension Strings {
    static let searchSettingsButtonTitle = NSLocalizedString("SearchSettingsButtonTitle", tableName: "BraveShared", bundle: .module, value: "Search Settings", comment: "Label for search settings button.")
    static let searchEngineFormatText = NSLocalizedString("SearchEngineFormatText", tableName: "BraveShared", bundle: .module, value: "%@ search", comment: "Label for search engine buttons. The argument corresponds to the name of the search engine.")
    static let searchSuggestionFromFormatText = NSLocalizedString("SearchSuggestionFromFormatText", tableName: "BraveShared", bundle: .module, value: "Search suggestions from %@", comment: "Accessibility label for image of default search engine displayed left to the actual search suggestions from the engine. The parameter substituted for \"%@\" is the name of the search engine. E.g.: Search suggestions from Google")
    static let searchesForSuggestionButtonAccessibilityText = NSLocalizedString("SearchesForSuggestionButtonAccessibilityText", tableName: "BraveShared", bundle: .module, value: "Searches for the suggestion", comment: "Accessibility hint describing the action performed when a search suggestion is clicked")
    static let searchSuggestionSectionTitleFormat = NSLocalizedString("SearchSuggestionSectionTitleFormat", tableName: "BraveShared", bundle: .module, value: "%@ Search", comment: "Section Title when showing search suggestions. The parameter substituted for \"%@\" is the name of the search engine. E.g.: Google Search")
    static let turnOnSearchSuggestions = NSLocalizedString("Turn on search suggestions?", tableName: "BraveShared", bundle: .module, comment: "Prompt shown before enabling provider search queries")
    static let searchSuggestionSectionTitleNoSearchFormat = NSLocalizedString("SearchSuggestionSectionTitleNoSearchFormat", tableName: "BraveShared", bundle: .module, value: "Search", comment: "Section Title when showing search suggestions and the engine does not contain the word 'Search'.")
    static let noSearchResultsfound = NSLocalizedString("noSearchResultsfound", tableName: "BraveShared", bundle: .module, value: "No search results found.", comment: "The information title displayed when there is no search reault found")
    static let searchBookmarksTitle = NSLocalizedString("searchBookmarksTitle", tableName: "BraveShared", bundle: .module, value: "Search Bookmarks", comment: "The placeholder text for bookmark search")
}

// MARK: -  Authenticator.swift

public extension Strings {
    static let authPromptAlertCancelButtonTitle = NSLocalizedString("AuthPromptAlertCancelButtonTitle", tableName: "BraveShared", bundle: .module, value: "Cancel", comment: "Label for Cancel button")
    static let authPromptAlertLogInButtonTitle = NSLocalizedString("AuthPromptAlertLogInButtonTitle", tableName: "BraveShared", bundle: .module, value: "Log in", comment: "Authentication prompt log in button")
    static let authPromptAlertTitle = NSLocalizedString("AuthPromptAlertTitle", tableName: "BraveShared", bundle: .module, value: "Authentication required", comment: "Authentication prompt title")
    static let authPromptAlertFormatRealmMessageText = NSLocalizedString("AuthPromptAlertFormatRealmMessageText", tableName: "BraveShared", bundle: .module, value: "A username and password are being requested by %@. The site says: %@", comment: "Authentication prompt message with a realm. First parameter is the hostname. Second is the realm string")
    static let authPromptAlertMessageText = NSLocalizedString("AuthPromptAlertMessageText", tableName: "BraveShared", bundle: .module, value: "A username and password are being requested by %@.", comment: "Authentication prompt message with no realm. Parameter is the hostname of the site")
    static let authPromptAlertUsernamePlaceholderText = NSLocalizedString("AuthPromptAlertUsernamePlaceholderText", tableName: "BraveShared", bundle: .module, value: "Username", comment: "Username textbox in Authentication prompt")
    static let authPromptAlertPasswordPlaceholderText = NSLocalizedString("AuthPromptAlertPasswordPlaceholderText", tableName: "BraveShared", bundle: .module, value: "Password", comment: "Password textbox in Authentication prompt")
    static let authenticationLoginsTouchReason = NSLocalizedString("AuthenticationLoginsTouchReason", tableName: "BraveShared", bundle: .module, value: "This authenticates your access to Browser", comment: "Touch ID or PIN entry prompt subtitle when accessing Browser with the Browser Lock feature enabled")
}

// MARK: -  BrowserViewController.swift

public extension Strings {
    static let openNewTabButtonTitle = NSLocalizedString("OpenNewTabButtonTitle", tableName: "BraveShared", bundle: .module, value: "Open in New Tab", comment: "Context menu item for opening a link in a new tab")

    static let openImageInNewTabActionTitle = NSLocalizedString("OpenImageInNewTab", tableName: "BraveShared", bundle: .module, value: "Open Image In New Tab", comment: "Context menu for opening image in new tab")
    static let saveImageActionTitle = NSLocalizedString("SaveImageActionTitle", tableName: "BraveShared", bundle: .module, value: "Save Image", comment: "Context menu item for saving an image")
    static let accessPhotoDeniedAlertTitle = NSLocalizedString("AccessPhotoDeniedAlertTitle", tableName: "BraveShared", bundle: .module, value: "Browser would like to access your Photos", comment: "See http://mzl.la/1G7uHo7")
    static let accessPhotoDeniedAlertMessage = NSLocalizedString("AccessPhotoDeniedAlertMessage", tableName: "BraveShared", bundle: .module, value: "This allows you to save the image to your Camera Roll.", comment: "See http://mzl.la/1G7uHo7")
    static let openPhoneSettingsActionTitle = NSLocalizedString("OpenPhoneSettingsActionTitle", tableName: "BraveShared", bundle: .module, value: "Open Settings", comment: "See http://mzl.la/1G7uHo7")
    static let copyImageActionTitle = NSLocalizedString("CopyImageActionTitle", tableName: "BraveShared", bundle: .module, value: "Copy Image", comment: "Context menu item for copying an image to the clipboard")
    static let closeAllTabsTitle = NSLocalizedString("CloseAllTabsTitle", tableName: "BraveShared", bundle: .module, value: "Close All %i Tabs", comment: "")
    static let closeAllTabsPrompt =
        NSLocalizedString(
            "closeAllTabsPrompt",
    ...
    static let savedTabsFolderTitle = NSLocalizedString("SavedTabsFolderTitle", tableName: "BraveShared", bundle: .module, value: "Saved Tabs", comment: "The title for the folder created when all bookmarks are being ")
    static let bookmarkAllTabsTitle = NSLocalizedString("BookmarkAllTabsTitle", tableName: "BraveShared", bundle: .module, value: "Add Bookmark for %lld Tabs", comment: "Action item title of long press for Adding Bookmark for All Tabs in Tab List - The parameter indicates the number of tabs like Add Bookmark for 5 Tabs")
    static let duplicateActiveTab =
        NSLocalizedString(
            "DuplicateActiveTab",
            tableName: "BraveShared",
            bundle: .module,
    ...
    static let suppressAlertsActionTitle = NSLocalizedString("SuppressAlertsActionTitle", tableName: "BraveShared", bundle: .module, value: "Suppress Alerts", comment: "Title of alert that seeks permission from user to suppress future JS alerts")
    static let suppressAlertsActionMessage = NSLocalizedString("SuppressAlertsActionMessage", tableName: "BraveShared", bundle: .module, value: "Prevent this page from creating additional alerts", comment: "Message body of alert that seeks permission from user to suppress future JS alerts")
    static let openDownloadsFolderErrorDescription =
        NSLocalizedString(
    ...
    static let openInNewWindowTitle = NSLocalizedString("OpenInNewWindowTitle", tableName: "BraveShared", bundle: .module, value: "Open in New Window", comment: "Context menu item for opening a link in a new window")
    static let openInNewPrivateWindowTitle = NSLocalizedString("OpenInNewPrivateWindowTitle", tableName: "BraveShared", bundle: .module, value: "Open in New Private Window", comment: "Context menu item for opening a link in a new private browsing window")
    static let newWindowTitle = NSLocalizedString("NewWindowTitle", tableName: "BraveShared", bundle: .module, value: "New Window", comment: "Context menu item for opening a new window")
    static let newPrivateWindowTitle = NSLocalizedString("NewPrivateWindowTitle", tableName: "BraveShared", bundle: .module, value: "New Private Window", comment: "Context menu item for opening a new private browsing window")
}

// MARK: -  DefaultBrowserIntroCalloutViewController.swift

public extension Strings {
    enum DefaultBrowserCallout {
        public static let introPrimaryText =
            NSLocalizedString(
                "defaultBrowserCallout.introPrimaryText",
                tableName: "BraveShared", bundle: .module,
                value: "Open all links with Browser to protect your privacy",
        ...
        public static let introSecondaryText =
            NSLocalizedString(
                ...
                tableName: "BraveShared", bundle: .module,
                value: "Browser Shields block trackers & ads, saves data, and saves you time on every site you visit",
        ...
        public static let introTertiaryText =
            NSLocalizedString(
                ...
                tableName: "BraveShared", bundle: .module,
                value: "Open Settings, tap Default Browser App, and select Browser.",
        ...
        public static let notificationTitle =
            NSLocalizedString(
                ...
                tableName: "BraveShared", bundle: .module,
                value: "Get Browser protection, on every link",
                comment: "Notification title to promote setting Browser app as default browser")

        public static let notificationBody =
            NSLocalizedString(
                "defaultBrowserCallout.notificationBody",
                tableName: "BraveShared", bundle: .module,
                value: "Set Browser as your default browser",
                comment: "Notification body to promote setting Browser app as default browser")
    }
}
...
public extension Strings {
    enum Callout {
        public static let privacyAgreement = NSLocalizedString("PrivacyAgreement", tableName: "BraveShared", bundle: .module, value: "Privacy Agreement", comment: "隐私协议")
        public static let privacyAgreementDetails = NSLocalizedString("PrivacyAgreementDetails", tableName: "BraveShared", bundle: .module, value: "This is a user privacy and license agreement. Before using this software, please read and understand its details. Once you choose to agree, it means you have carefully read the user agreement and accept its terms.", comment: "这是一份用户隐私和许可协议，在你使用本软件之前，请你务必阅读了解其详细信息。在确保您理解其内容含义后，再做出选择，一旦您选择了同意即代表您已经仔细阅读了用户协议并接受其内容条款。")
        public static let privacyAgreementLink = NSLocalizedString("PrivacyAgreementLink", tableName: "BraveShared", bundle: .module, value: "Tap here to view the Privacy Agreement and Terms of Service", comment: "点此查看隐私协议及服务协议")
        public static let agreeToAgreement = NSLocalizedString("AgreeToAgreement", tableName: "BraveShared", bundle: .module, value: "Agree to Agreement", comment: "同意此协议")
        public static let doNotUse = NSLocalizedString("DoNotUse", tableName: "BraveShared", bundle: .module, value: "Do Not Use", comment: "暂不使用")
        public static let beforeUsingRead =
            NSLocalizedString("BeforeUsingRead", tableName: "BraveShared", bundle: .module, value: "Before Using, Read", comment: "使用前请阅读")
        ...
        public static let defaultBrowserCalloutDescription =
            NSLocalizedString(
                ...
                tableName: "BraveShared", bundle: .module,
                value: "With Browser as default, every link you tap opens with Browser's privacy protections.",
        ...
        public static let defaultBrowserCalloutButtonDescription =
            NSLocalizedString(
                ...
                tableName: "BraveShared", bundle: .module,
                value: "Set Browser as Default Browser?",
        ...
        public static let privacyEverywhereCalloutDescription =
            NSLocalizedString(
                ...
                tableName: "BraveShared", bundle: .module,
                value: "Get Browser privacy on your computer or tablet, and sync bookmarks & extensions between devices.",
        ...
        public static let p3aCalloutTitle =
            NSLocalizedString(
                ...
                tableName: "BraveShared", bundle: .module,
                value: "Help make Browser better.",
        ...
        public static let p3aCalloutDescription =
            NSLocalizedString(
                ...
                tableName: "BraveShared", bundle: .module,
                value: "This helps us learn what Browser features are used most often. Change at any time in Browser Settings under ‘Browser Shields and Other Privacy Settings.",
        ...
        public static let bottomBarCalloutTitle =
            NSLocalizedString(
                ...
                tableName: "BraveShared", bundle: .module,
                value: "Customize Browser Tabs Bar",
    ...
    enum Onboarding {
        ...
        public static let blockedAdsOnboardingInstructionsText =
            NSLocalizedString(
                ...
                tableName: "BraveShared", bundle: .module,
                value: "Tap to view Browser Shields",
        ...
        public static let blockedAdsOnboardingFootnoteText =
            NSLocalizedString(
                ...
                tableName: "BraveShared", bundle: .module,
                value: "See all the bad stuff Browser blocked, on every page, with Shields.",
                comment: "The footnote indicating what Browser shields is blocking")
        ...
        public static let linkReceiptTitle =
            NSLocalizedString(
                ...
                tableName: "BraveShared", bundle: .module,
                value: "Extend your Browser Firewall + VPN protection",
        ...
        public static let linkReceiptDescription =
            NSLocalizedString(
                ...
                tableName: "BraveShared", bundle: .module,
                value: "Your Browser VPN subscription can protect up to 5 devices, across Android, iOS, and desktop. Just link your App Store subscription to your Browser account.",
...
public extension Strings {
    static let errorPageReloadButtonTitle = NSLocalizedString("ErrorPageReloadButtonTitle", tableName: "BraveShared", bundle: .module, value: "Reload", comment: "Shown in error pages on a button that will try to load the page again")
    static let errorPageOpenInSafariButtonTitle = NSLocalizedString("ErrorPageOpenInSafariButtonTitle", tableName: "BraveShared", bundle: .module, value: "Open in Safari", comment: "Shown in error pages for files that can't be shown and need to be downloaded.")
    static let errorPageCantBeReachedTry =
        NSLocalizedString(
...
public extension Strings {
    static let findInPagePreviousResultButtonAccessibilityLabel = NSLocalizedString("FindInPagePreviousResultButtonAccessibilityLabel", tableName: "BraveShared", bundle: .module, value: "Previous in-page result", comment: "Accessibility label for previous result button in Find in Page Toolbar.")
    static let findInPageNextResultButtonAccessibilityLabel = NSLocalizedString("FindInPageNextResultButtonAccessibilityLabel", tableName: "BraveShared", bundle: .module, value: "Next in-page result", comment: "Accessibility label for next result button in Find in Page Toolbar.")
    static let findInPageDoneButtonAccessibilityLabel = NSLocalizedString("FindInPageDoneButtonAccessibilityLabel", tableName: "BraveShared", bundle: .module, value: "Done", comment: "Done button in Find in Page Toolbar.")
    static let findInPageFormat = NSLocalizedString("FindInPageFormat", tableName: "BraveShared", bundle: .module, value: "Find \"%@\"", comment: "Find %@ text in page.")
}

// MARK: -  ReaderModeBarView.swift

public extension Strings {
    static let readerModeDisplaySettingsButtonTitle = NSLocalizedString("ReaderModeDisplaySettingsButtonTitle", tableName: "BraveShared", bundle: .module, value: "Display Settings", comment: "Name for display settings button in reader mode. Display in the meaning of presentation, not monitor.")
}

// MARK: -  TabLocationView.swift

public extension Strings {
    static let tabToolbarStopButtonAccessibilityLabel = NSLocalizedString("TabToolbarStopButtonAccessibilityLabel", tableName: "BraveShared", bundle: .module, value: "Stop", comment: "Accessibility Label for the tab toolbar Stop button")
    static let tabToolbarPlaylistButtonAccessibilityLabel = NSLocalizedString("TabToolbarPlaylistButtonAccessibilityLabel", tableName: "BraveShared", bundle: .module, value: "Playlist", comment: "Accessibility Label for the tab toolbar Playlist button")
    static let tabToolbarAddToPlaylistButtonAccessibilityLabel = NSLocalizedString("tabToolbarAddToPlaylistButtonAccessibilityLabel", tableName: "BraveShared", bundle: .module, value: "Add to Playlist", comment: "Accessibility Label for the tab toolbar Add to Playlist button")
    static let tabToolbarReloadButtonAccessibilityLabel = NSLocalizedString("TabToolbarReloadButtonAccessibilityLabel", tableName: "BraveShared", bundle: .module, value: "Reload", comment: "Accessibility Label for the tab toolbar Reload button")
    static let tabToolbarVoiceSearchButtonAccessibilityLabel = NSLocalizedString("tabToolbarVoiceSearchButtonAccessibilityLabel", tableName: "BraveShared", bundle: .module, value: "Voice Search", comment: "Accessibility Label for the tab toolbar Reload button")
    static let tabToolbarSearchAddressPlaceholderText = NSLocalizedString("TabToolbarSearchAddressPlaceholderText", tableName: "BraveShared", bundle: .module, value: "Search or enter address", comment: "The text shown in the URL bar on about:home")
    static let tabToolbarWarningImageAccessibilityLabel = NSLocalizedString("TabToolbarWarningImageAccessibilityLabel", tableName: "BraveShared", bundle: .module, value: "Insecure connection", comment: "Accessibility label for the lock icon, which is only present if the connection is insecure")
    static let tabToolbarLockImageAccessibilityLabel = NSLocalizedString("TabToolbarLockImageAccessibilityLabel", tableName: "BraveShared", bundle: .module, value: "Secure connection", comment: "Accessibility label for the lock icon, which is only present if the connection is secure")
    static let tabToolbarReaderViewButtonAccessibilityLabel = NSLocalizedString("TabToolbarReaderViewButtonAccessibilityLabel", tableName: "BraveShared", bundle: .module, value: "Reader View", comment: "Accessibility label for the Reader View button")
    static let tabToolbarReaderViewButtonTitle = NSLocalizedString("TabToolbarReaderViewButtonTitle", tableName: "BraveShared", bundle: .module, value: "Add to Reading List", comment: "Accessibility label for action adding current page to reading list.")
    static let searchSuggestionsSectionHeader = NSLocalizedString("SearchSuggestionsSectionHeader", tableName: "BraveShared", bundle: .module, value: "Search Suggestions", comment: "Section header for search suggestions option")
    static let findOnPageSectionHeader = NSLocalizedString("FindOnPageSectionHeader", tableName: "BraveShared", bundle: .module, value: "On This Page", comment: "Section header for find in page option")
    static let searchHistorySectionHeader = NSLocalizedString("SearchHistorySectionHeader", tableName: "BraveShared", bundle: .module, value: "Open Tabs & Bookmarks & History", comment: "Section header for history and bookmarks and open tabs option")
    static let searchSuggestionOpenTabActionTitle = NSLocalizedString("searchSuggestionOpenTabActionTitle", tableName: "BraveShared", bundle: .module, value: "Switch to this tab", comment: "Action title for Switching to an existing tab for the suggestion item shown on the table list")
    static let tabToolbarNotSecureTitle = NSLocalizedString("tabToolbarNotSecureTitle", tableName: "BraveShared", bundle: .module, value: "Not Secure", comment: "A label shown next to a URL that loaded in some insecure way")
}

// MARK: - PageSecurityView.swift

public extension Strings {
    enum PageSecurityView {
...
public extension Strings {
    static let tabToolbarBackButtonAccessibilityLabel = NSLocalizedString("TabToolbarBackButtonAccessibilityLabel", tableName: "BraveShared", bundle: .module, value: "Back", comment: "Accessibility label for the Back button in the tab toolbar.")
    static let tabToolbarForwardButtonAccessibilityLabel = NSLocalizedString("TabToolbarForwardButtonAccessibilityLabel", tableName: "BraveShared", bundle: .module, value: "Forward", comment: "Accessibility Label for the tab toolbar Forward button")
    static let tabToolbarShareButtonAccessibilityLabel = NSLocalizedString("TabToolbarShareButtonAccessibilityLabel", tableName: "BraveShared", bundle: .module, value: "Share", comment: "Accessibility Label for the browser toolbar Share button")
    static let tabToolbarMenuButtonAccessibilityLabel = NSLocalizedString("TabToolbarMenuButtonAccessibilityLabel", tableName: "BraveShared", bundle: .module, value: "Menu", comment: "Accessibility Label for the browser toolbar Menu button")
    static let tabToolbarAddTabButtonAccessibilityLabel = NSLocalizedString("TabToolbarAddTabButtonAccessibilityLabel", tableName: "BraveShared", bundle: .module, value: "Add Tab", comment: "Accessibility label for the Add Tab button in the Tab Tray.")
    static let tabToolbarAccessibilityLabel = NSLocalizedString("TabToolbarAccessibilityLabel", tableName: "BraveShared", bundle: .module, value: "Navigation Toolbar", comment: "Accessibility label for the navigation toolbar displayed at the bottom of the screen.")
}

// MARK: -  TabTrayController.swift

public extension Strings {
    static let tabAccessibilityCloseActionLabel = NSLocalizedString("TabAccessibilityCloseActionLabel", tableName: "BraveShared", bundle: .module, value: "Close", comment: "Accessibility label for action denoting closing a tab in tab list (tray)")
    static let tabTrayAccessibilityLabel = NSLocalizedString("TabTrayAccessibilityLabel", tableName: "BraveShared", bundle: .module, value: "Tabs Tray", comment: "Accessibility label for the Tabs Tray view.")
    static let tabTrayEmptyVoiceOverText = NSLocalizedString("TabTrayEmptyVoiceOverText", tableName: "BraveShared", bundle: .module, value: "No tabs", comment: "Message spoken by VoiceOver to indicate that there are no tabs in the Tabs Tray")
    static let tabTraySingleTabPositionFormatVoiceOverText = NSLocalizedString("TabTraySingleTabPositionFormatVoiceOverText", tableName: "BraveShared", bundle: .module, value: "Tab %@ of %@", comment: "Message spoken by VoiceOver saying the position of the single currently visible tab in Tabs Tray, along with the total number of tabs. E.g. \"Tab 2 of 5\" says that tab 2 is visible (and is the only visible tab), out of 5 tabs total.")
    static let tabTrayMultiTabPositionFormatVoiceOverText = NSLocalizedString("TabTrayMultiTabPositionFormatVoiceOverText", tableName: "BraveShared", bundle: .module, value: "Tabs %@ to %@ of %@", comment: "Message spoken by VoiceOver saying the range of tabs that are currently visible in Tabs Tray, along with the total number of tabs. E.g. \"Tabs 8 to 10 of 15\" says tabs 8, 9 and 10 are visible, out of 15 tabs total.")
    static let tabTrayClosingTabAccessibilityNotificationText = NSLocalizedString("TabTrayClosingTabAccessibilityNotificationText", tableName: "BraveShared", bundle: .module, value: "Closing tab", comment: "Accessibility label (used by assistive technology) notifying the user that the tab is being closed.")
    static let tabTrayCellCloseAccessibilityHint = NSLocalizedString("TabTrayCellCloseAccessibilityHint", tableName: "BraveShared", bundle: .module, value: "Swipe right or left with three fingers to close the tab.", comment: "Accessibility hint for tab tray's displayed tab.")
    static let tabTrayAddTabAccessibilityLabel = NSLocalizedString("TabTrayAddTabAccessibilityLabel", tableName: "BraveShared", bundle: .module, value: "Add Tab", comment: "Accessibility label for the Add Tab button in the Tab Tray.")
    static let `private` = NSLocalizedString("Private", tableName: "BraveShared", bundle: .module, value: "Private", comment: "Private button title")
    static let privateBrowsing = NSLocalizedString("PrivateBrowsing", tableName: "BraveShared", bundle: .module, value: "Private Browsing", comment: "")
    static let tabTraySearchBarTitle = NSLocalizedString("TabTraySearchBarTitle", tableName: "BraveShared", bundle: .module, value: "Search Tabs", comment: "Title displayed for placeholder inside Search Bar in Tab Tray")
}

// MARK: -  TabTrayButtonExtensions.swift

public extension Strings {
    static let tabPrivateModeToggleAccessibilityLabel = NSLocalizedString("TabPrivateModeToggleAccessibilityLabel", tableName: "BraveShared", bundle: .module, value: "Private Mode", comment: "Accessibility label for toggling on/off private mode")
    static let tabPrivateModeToggleAccessibilityHint = NSLocalizedString("TabPrivateModeToggleAccessibilityHint", tableName: "BraveShared", bundle: .module, value: "Turns private mode on or off", comment: "Accessiblity hint for toggling on/off private mode")
    static let tabPrivateModeToggleAccessibilityValueOn = NSLocalizedString("TabPrivateModeToggleAccessibilityValueOn", tableName: "BraveShared", bundle: .module, value: "On", comment: "Toggled ON accessibility value")
    static let tabPrivateModeToggleAccessibilityValueOff = NSLocalizedString("TabPrivateModeToggleAccessibilityValueOff", tableName: "BraveShared", bundle: .module, value: "Off", comment: "Toggled OFF accessibility value")
    static let tabTrayNewTabButtonAccessibilityLabel = NSLocalizedString("TabTrayNewTabButtonAccessibilityLabel", tableName: "BraveShared", bundle: .module, value: "New Tab", comment: "Accessibility label for the New Tab button in the tab toolbar.")
}

// MARK: -  URLBarView.swift

public extension Strings {
    static let URLBarViewLocationTextViewAccessibilityLabel = NSLocalizedString("URLBarViewLocationTextViewAccessibilityLabel", tableName: "BraveShared", bundle: .module, value: "Address and Search", comment: "Accessibility label for address and search field, both words (Address, Search) are therefore nouns.")
}
...
public extension Strings {
    ...
    static let loginListDeselectAllButtonTitle = NSLocalizedString("LoginListDeselectAllButtonTitle", tableName: "BraveShared", bundle: .module, value: "Deselect All", comment: "Label for the button used to deselect all logins.")
    static let loginListSelectAllButtonTitle = NSLocalizedString("LoginListSelectAllButtonTitle", tableName: "BraveShared", bundle: .module, value: "Select All", comment: "Label for the button used to select all logins.")
    static let loginListScreenTitle = NSLocalizedString("LoginListScreenTitle", tableName: "BraveShared", bundle: .module, value: "Logins", comment: "Title for Logins List View screen.")
    static let loginListNoLoginTitle = NSLocalizedString("LoginListNoLoginTitle", tableName: "BraveShared", bundle: .module, value: "No logins found", comment: "Label displayed when no logins are found after searching.")
}

// MARK: -  LoginDetailViewController.swift

public extension Strings {
    static let loginDetailUsernameCellTitle = NSLocalizedString("LoginDetailUsernameCellTitle", tableName: "BraveShared", bundle: .module, value: "username", comment: "Label displayed above the username row in Login Detail View.")
    static let loginDetailPasswordCellTitle = NSLocalizedString("LoginDetailPasswordCellTitle", tableName: "BraveShared", bundle: .module, value: "password", comment: "Label displayed above the password row in Login Detail View.")
    static let loginDetailWebsiteCellTitle = NSLocalizedString("LoginDetailWebsiteCellTitle", tableName: "BraveShared", bundle: .module, value: "website", comment: "Label displayed above the website row in Login Detail View.")
    static let loginDetailLastModifiedCellFormatTitle = NSLocalizedString("LoginDetailLastModifiedCellFormatTitle", tableName: "BraveShared", bundle: .module, value: "Last modified %@", comment: "Footer label describing when the current login was last modified with the timestamp as the parameter.")
}

// MARK: -  ReaderModeHandler.swift

public extension Strings {
    static let readerModeLoadingContentDisplayText = NSLocalizedString("ReaderModeLoadingContentDisplayText", tableName: "BraveShared", bundle: .module, value: "Loading content…", comment: "Message displayed when the reader mode page is loading. This message will appear only when sharing to Browser reader mode from another app.")
    static let readerModePageCantShowDisplayText = NSLocalizedString("ReaderModePageCantShowDisplayText", tableName: "BraveShared", bundle: .module, value: "The page could not be displayed in Reader View.", comment: "Message displayed when the reader mode page could not be loaded. This message will appear only when sharing to Browser reader mode from another app.")
    static let readerModeLoadOriginalLinkText = NSLocalizedString("ReaderModeLoadOriginalLinkText", tableName: "BraveShared", bundle: .module, value: "Load original page", comment: "Link for going to the non-reader page when the reader view could not be loaded. This message will appear only when sharing to Browser reader mode from another app.")
    static let readerModeErrorConvertDisplayText = NSLocalizedString("ReaderModeErrorConvertDisplayText", tableName: "BraveShared", bundle: .module, value: "There was an error converting the page", comment: "Error displayed when reader mode cannot be enabled")
}

// MARK: -  ReaderModeStyleViewController.swift

public extension Strings {
    static let readerModeBrightSliderAccessibilityLabel = NSLocalizedString("ReaderModeBrightSliderAccessibilityLabel", tableName: "BraveShared", bundle: .module, value: "Brightness", comment: "Accessibility label for brightness adjustment slider in Reader Mode display settings")
    static let readerModeFontTypeButtonAccessibilityHint = NSLocalizedString("ReaderModeFontTypeButtonAccessibilityHint", tableName: "BraveShared", bundle: .module, value: "Changes font type.", comment: "Accessibility hint for the font type buttons in reader mode display settings")
    static let readerModeFontButtonSansSerifTitle = NSLocalizedString("ReaderModeFontButtonSansSerifTitle", tableName: "BraveShared", bundle: .module, value: "Sans-serif", comment: "Font type setting in the reading view settings")
    static let readerModeFontButtonSerifTitle = NSLocalizedString("ReaderModeFontButtonSerifTitle", tableName: "BraveShared", bundle: .module, value: "Serif", comment: "Font type setting in the reading view settings")
    static let readerModeSmallerFontButtonTitle = NSLocalizedString("ReaderModeSmallerFontButtonTitle", tableName: "BraveShared", bundle: .module, value: "-", comment: "Button for smaller reader font size. Keep this extremely short! This is shown in the reader mode toolbar.")
    static let readerModeSmallerFontButtonAccessibilityLabel = NSLocalizedString("ReaderModeSmallerFontButtonAccessibilityLabel", tableName: "BraveShared", bundle: .module, value: "Decrease text size", comment: "Accessibility label for button decreasing font size in display settings of reader mode")
    static let readerModeBiggerFontButtonTitle = NSLocalizedString("ReaderModeBiggerFontButtonTitle", tableName: "BraveShared", bundle: .module, value: "+", comment: "Button for larger reader font size. Keep this extremely short! This is shown in the reader mode toolbar.")
    static let readerModeBiggerFontButtonAccessibilityLabel = NSLocalizedString("ReaderModeBiggerFontButtonAccessibilityLabel", tableName: "BraveShared", bundle: .module, value: "Increase text size", comment: "Accessibility label for button increasing font size in display settings of reader mode")
    static let readerModeFontSizeLabelText = NSLocalizedString("ReaderModeFontSizeLabelText", tableName: "BraveShared", bundle: .module, value: "Aa", comment: "Button for reader mode font size. Keep this extremely short! This is shown in the reader mode toolbar.")
    static let readerModeThemeButtonAccessibilityHint = NSLocalizedString("ReaderModeThemeButtonAccessibilityHint", tableName: "BraveShared", bundle: .module, value: "Changes color theme.", comment: "Accessibility hint for the color theme setting buttons in reader mode display settings")

    static let readerModeButtonTitle =
        NSLocalizedString(
...
public extension Strings {
    static let searchSettingNavTitle = NSLocalizedString("SearchSettingNavTitle", tableName: "BraveShared", bundle: .module, value: "Search", comment: "Navigation title for search settings.")
    static let searchSettingSuggestionCellTitle = NSLocalizedString("SearchSettingSuggestionCellTitle", tableName: "BraveShared", bundle: .module, value: "Show Search Suggestions", comment: "Label for show search suggestions setting.")
    static let searchSettingRecentSearchesCellTitle = NSLocalizedString("SearchSettingRecentSearchesCellTitle", tableName: "BraveShared", bundle: .module, value: "Show Recent Searches", comment: "Label for showing recent search setting.")
    static let searchSettingBrowserSuggestionCellTitle =
    ...
    static let searchSettingBrowserSuggestionCellDescription =
    ...
    static let searchSettingAddCustomEngineCellTitle =
    ...
    static let aggregatedSearchPanelTitle =
        NSLocalizedString("AggregatedSearchPanelTitle", tableName: "BraveShared", bundle: .module,
                          value: "Aggregated Search Engine Panel", comment: "Toggle label for Aggregated Search Engine Panel")
    
    static let aggregatedSearchPanelDetail =
        NSLocalizedString("AggregatedSearchPanelDetail", tableName: "BraveShared", bundle: .module,
                          value: "Quickly switch between search engines, please refresh the original webpage after modification", comment: "Description for Aggregated Search Engine Panel")
    static let syncAddToHomePageFavorites = NSLocalizedString("SyncAddToHomePageFavorites", tableName: "BraveShared", bundle: .module, value: "Sync Add to Home Page Favorites", comment: "Sync text for adding to home page favorites")
    static let qATitle =
        NSLocalizedString("QATitle", tableName: "BraveShared", bundle: .module,
                          value: "Ai Help", comment: "Toggle label for QnA Assistant")
    
    static let qADetail =
        NSLocalizedString("QADetail", tableName: "BraveShared", bundle: .module,
                          value: "Use AI to integrate search results, please refresh the original webpage after modification", comment: "Description for QnA Assistant")
}

// MARK: - SearchCustomEngineViewController

public extension Strings {
    enum CustomSearchEngine {
        ...
        public static let insecureSearchTemplateURLErrorDescription = NSLocalizedString("customSearchEngine.insecureSearchTemplateURLErrorDescription", tableName: "BraveShared", bundle: .module,
                                                                                        ...
                                                                                        comment: "A description explaining that search template url is insecure, it is used for instance - Insecure Custom Search Template for Browser Search, Browser Search is a search engineand on a new seperate line")
        ...
        public static let insecureSuggestionTemplateURLErrorDescription = NSLocalizedString("customSearchEngine.insecureSuggestionTemplateURLErrorDescription", tableName: "BraveShared", bundle: .module,
                                                                                            ...
                                                                                            comment: "A description explaining that suggestion template url is insecure, it is used for instance - Insecure Custom Suggestion Template for Browser Search, Browser Search is name of search engine on a new seperate line")
        ...
        public static let searchTemplateTitle = NSLocalizedString("customSearchEngine.searchTemplateTitle", tableName: "BraveShared", bundle: .module,
                                                                  ...
                                                                  comment: "Search Template title - for instance it will be used Search Template: Browser Search - Browser Search is the name of Search Engine on  seperate line")
        ...
        public static let suggestionTemplateTitle = NSLocalizedString("customSearchEngine.suggestionTemplateTitle", tableName: "BraveShared", bundle: .module,
                                                                      ...
                                                                      comment: "Suggestion Template title - for instance it will be used Suggestion Template: Browser Search - Browser Search is the name of Search Engine on  seperate line")
...
public extension Strings {
    enum OptionsMenu {
        ...
        public static let braveVPNItemTitle = NSLocalizedString(
            ...
            bundle: .module,
            value: "VPN",
            comment: "Browser VPN Item Menu title")
        public static let braveVPNItemDescription = NSLocalizedString(
            ...
            comment: "The subtitle description of menu item Browser VPN")
        public static let braveTalkItemTitle = NSLocalizedString(
            "optionsMenu.braveTalkItemTitle",
            tableName: "BraveShared",
            bundle: .module,
            value: "Talk",
            comment: "Browser Talk Item Menu title")
        public static let braveTalkItemDescription = NSLocalizedString(
            ...
            comment: "The subtitle description of menu item Browser Talk")
        public static let braveNewsItemTitle = NSLocalizedString(
            "optionsMenu.braveNewsItemTitle",
            tableName: "BraveShared",
            bundle: .module,
            value: "News",
            comment: "Browser News Item Menu title")
        public static let braveNewsItemDescription = NSLocalizedString(
            ...
            comment: "The subtitle description of menu item Browser News")
        ...
        public static let bravePlaylistItemDescription = NSLocalizedString(
            ...
            comment: "The subtitle description of menu item Browser Playlist")
        public static let braveWalletItemDescription = NSLocalizedString(
            ...
            comment: "The subtitle description of menu item Browser Wallet")
    }
}
...
public extension Strings {
    enum BraveSearchPromotion {
        public static let braveSearchPromotionBannerTitle = NSLocalizedString(
            ...
            comment: "Browser Search Banner Promotion title in Search Suggestions")
        public static let braveSearchPromotionBannerDescription = NSLocalizedString(
            "braveSearchPromotion.bannerDescription",
            tableName: "BraveShared",
            bundle: .module,
            value: "Browser Search doesn't track you, your queries, or your clicks.",
            comment: "Browser Search Banner Promotion description content in Search Suggestions")
        public static let braveSearchPromotionBannerTryButtonTitle = NSLocalizedString(
            "braveSearchPromotion.bannerTryButtonTitle",
            tableName: "BraveShared",
            bundle: .module,
            value: "Try Browser Search",
            comment: "Browser Search Banner Promotion title for try button in Search Suggestions")
        public static let braveSearchPromotionBannerMaybeLaterButtonTitle = NSLocalizedString(
            ...
            bundle: .module,
            value: "Maybe later",
            comment: "Browser Search Banner Promotion title for maybe later button to activate promotion later in Search Suggestions")
        public static let braveSearchPromotionBannerDismissButtonTitle = NSLocalizedString(
            ...
            bundle: .module,
            value: "Dismiss",
            comment: "Browser Search Banner Promotion title for dismiss button to remove promotion in Search Suggestions")
    }
}
...
public extension Strings {
    static let settingsContentLoadErrorMessage = NSLocalizedString("SettingsContentLoadErrorMessage", tableName: "BraveShared", bundle: .module, value: "Could not load page.", comment: "Error message that is shown in settings when there was a problem loading")
}

// MARK: -  SearchInputView.swift

public extension Strings {
    static let searchInputViewTextFieldAccessibilityLabel = NSLocalizedString("SearchInputViewTextFieldAccessibilityLabel", tableName: "BraveShared", bundle: .module, value: "Search Input Field", comment: "Accessibility label for the search input field in the Logins list")
    static let searchInputViewTitle = NSLocalizedString("SearchInputViewTitle", tableName: "BraveShared", bundle: .module, value: "Search", comment: "Title for the search field at the top of the Logins list screen")
    static let searchInputViewClearButtonTitle = NSLocalizedString("SearchInputViewClearButtonTitle", tableName: "BraveShared", bundle: .module, value: "Clear Search", comment: "Accessibility message e.g. spoken by VoiceOver after the user taps the close button in the search field to clear the search and exit search mode")
    static let searchInputViewOverlayAccessibilityLabel = NSLocalizedString("SearchInputViewOverlayAccessibilityLabel", tableName: "BraveShared", bundle: .module, value: "Enter Search Mode", comment: "Accessibility label for entering search mode for logins")
}

// MARK: -  MenuHelper.swift

public extension Strings {
    static let menuItemRevealPasswordTitle = NSLocalizedString("MenuItemRevealPasswordTitle", tableName: "BraveShared", bundle: .module, value: "Reveal", comment: "Reveal password text selection menu item")
    static let menuItemHidePasswordTitle = NSLocalizedString("MenuItemHidePasswordTitle", tableName: "BraveShared", bundle: .module, value: "Hide", comment: "Hide password text selection menu item")
    static let menuItemCopyTitle = NSLocalizedString("MenuItemCopyTitle", tableName: "BraveShared", bundle: .module, value: "Copy", comment: "Copy password text selection menu item")
    static let menuItemOpenWebsiteTitle = NSLocalizedString("MenuItemOpenTitle", tableName: "BraveShared", bundle: .module, value: "Open Website", comment: "Open and Fill website text selection menu item")
}

// MARK: - Settings.

public extension Strings {
    static let clearPrivateData = NSLocalizedString("ClearPrivateData", tableName: "BraveShared", bundle: .module, value: "Clear Private Data", comment: "Section title in settings panel")
    static let clearPrivateDataAlertTitle = NSLocalizedString("ClearPrivateDataAlertTitle", tableName: "BraveShared", bundle: .module, value: "Clear Data", comment: "")
    static let clearPrivateDataAlertMessage = NSLocalizedString("ClearPrivateDataAlertMessage", tableName: "BraveShared", bundle: .module, value: "Are you sure?", comment: "")
    static let clearPrivateDataAlertYesAction = NSLocalizedString("ClearPrivateDataAlertYesAction", tableName: "BraveShared", bundle: .module, value: "Yes, Delete", comment: "")
    static let clearDataNow = NSLocalizedString("ClearPrivateDataNow", tableName: "BraveShared", bundle: .module, value: "Clear Data Now", comment: "Button in settings that clears private data for the selected items.")
    static let displaySettingsSection = NSLocalizedString("DisplaySettingsSection", tableName: "BraveShared", bundle: .module, value: "Display", comment: "Section name for display preferences.")
    static let tabsSettingsSectionTitle = NSLocalizedString("SettingsTabsSectionTitle", tableName: "BraveShared", bundle: .module, value: "Tabs", comment: "Tabs settings section title")
    static let tabsOptionTopBar = NSLocalizedString("SettingsTabsOptionTopBar", tableName: "BraveShared", bundle: .module, value: "Top Bar", comment: "An option for the URL bar position. (Top Bar and Bottom Bar). Refers to the location of the url bar")
    static let tabsOptionBottomBar = NSLocalizedString("SettingsTabsOptionBottomBar", tableName: "BraveShared", bundle: .module, value: "Bottom Bar", comment: "An option for the URL bar position. (Top Bar and Bottom Bar). Refers to the location of the url bar")
    static let otherSettingsSection = NSLocalizedString("OtherSettingsSection", tableName: "BraveShared", bundle: .module, value: "Other Settings", comment: "Section name for other settings.")
    static let otherPrivacySettingsSection = NSLocalizedString("OtherPrivacySettingsSection", tableName: "BraveShared", bundle: .module, value: "Other Privacy Settings", comment: "Section name for other privacy settings")
    static let braveRewardsTitle = NSLocalizedString("BraveRewardsTitle", tableName: "BraveShared", bundle: .module, value: "Browser Rewards", comment: "Browser Rewards settings title")
    static let hideRewardsIcon = NSLocalizedString("HideRewardsIcon", tableName: "BraveShared", bundle: .module, value: "Hide Browser Rewards Icon", comment: "Hides the rewards icon")
    static let hideRewardsIconSubtitle = NSLocalizedString("HideRewardsIconSubtitle", tableName: "BraveShared", bundle: .module, value: "Hides the Browser Rewards icon when Browser Rewards is not enabled", comment: "Hide the rewards icon explination.")
    static let walletCreationDate = NSLocalizedString("WalletCreationDate", tableName: "BraveShared", bundle: .module, value: "Wallet Creation Date", comment: "The date your wallet was created")
    static let copyWalletSupportInfo = NSLocalizedString("CopyWalletSupportInfo", tableName: "BraveShared", bundle: .module, value: "Copy Support Info", comment: "Copy rewards internals info for support")
    static let settingsLicenses = NSLocalizedString("SettingsLicenses", tableName: "BraveShared", bundle: .module, value: "Licenses", comment: "Row name for licenses.")
    static let openBraveRewardsSettings = NSLocalizedString("OpenBraveRewardsSettings", tableName: "BraveShared", bundle: .module, value: "Open Browser Rewards Settings", comment: "Button title for opening the Browser Rewards panel to settings")
    static let setDefaultBrowserSettingsCell =
        NSLocalizedString("setDefaultBrowserSettingsCell", tableName: "BraveShared", bundle: .module, value: "Set as Default Browser", comment: "Settings item to set the Browser as a default browser on the iOS device.")
    static let setDefaultBrowserCalloutTitle =
        NSLocalizedString(
            "setDefaultBrowserCalloutTitle", tableName: "BraveShared", bundle: .module,
            value: "Browser can now be set as your default browser in iOS. Tap here to open settings.", comment: "")
    static let defaultBrowserCalloutCloseAccesabilityLabel =
        NSLocalizedString(
    ...
    static let enablePullToRefresh =
        NSLocalizedString(
    ...
    enum Settings {
        ...
        public static let autocloseTabsSettingFooter =
            NSLocalizedString(
                ...
                bundle: .module, value: "Allow Browser to automatically close tabs that haven't recently been viewed.",
        ...
        public static let openYouTubeInBrave =
            NSLocalizedString(
                ...
                tableName: "BraveShared",
                bundle: .module,
                value: "Open YouTube links in Rainsee",
                comment: "A toggle label which lets the user always open YouTube urls in Browser")
        ...
        public static let sendUsagePingTitle =
            NSLocalizedString(
                ...
                tableName: "BraveShared",
                bundle: .module,
                value: "Automatically send daily usage ping to Browser",
        ...
        public static let sendUsagePingDescription =
            NSLocalizedString(
                ...
                tableName: "BraveShared",
                bundle: .module,
                value: "This anonymous private ping lets Browser estimate active users.",
...
public extension Strings {
    static let errorPagesCertWarningTitle = NSLocalizedString("ErrorPagesCertWarningTitle", tableName: "BraveShared", bundle: .module, value: "Your connection is not private", comment: "Title on the certificate error page")

    static let errorPagesCertErrorTitle = NSLocalizedString("ErrorPagesCertErrorTitle", tableName: "BraveShared", bundle: .module, value: "This site can’t provide a secure connection", comment: "Title on the certificate error page")

    static let errorPagesMoreDetailsButton = NSLocalizedString("ErrorPagesMoreDetailsButton", tableName: "BraveShared", bundle: .module, value: "More details", comment: "Label for button to perform advanced actions on the error page")

    static let errorPagesHideDetailsButton = NSLocalizedString("ErrorPagesHideDetailsButton", tableName: "BraveShared", bundle: .module, value: "Hide details", comment: "Label for button to hide advanced actions on the error page")

    static let errorPagesLearnMoreButton = NSLocalizedString("ErrorPagesLearnMoreButton", tableName: "BraveShared", bundle: .module, value: "Learn more", comment: "Label for learn more link on error page")

    static let errorPagesAdvancedWarningTitle = NSLocalizedString("ErrorPagesAdvancedWarningTitle", tableName: "BraveShared", bundle: .module, value: "Attackers might be trying to steal your information from %@ (for example, passwords, messages, or credit cards).", comment: "Warning text when clicking the Advanced button on error pages")

    static let errorPagesAdvancedWarningDetails = NSLocalizedString("ErrorPagesAdvancedWarningDetails", tableName: "BraveShared", bundle: .module, value: "This server could not prove that it is %@; its security certificate is not trusted by your device's operating system. This may be caused by a misconfiguration or an attacker trying to intercept your connection.", comment: "Additional warning text when clicking the Advanced button on error pages")

    static let errorPagesBackToSafetyButton = NSLocalizedString("ErrorPagesBackToSafetyButton", tableName: "BraveShared", bundle: .module, value: "Back to safety", comment: "Label for button to go back from the error page")

    static let errorPagesProceedAnywayButton = NSLocalizedString("ErrorPagesProceedAnywayButton", tableName: "BraveShared", bundle: .module, value: "Proceed to %@ (unsafe)", comment: "Button label to temporarily continue to the site from the certificate error page")

    static let errorPagesNoInternetTitle = NSLocalizedString("ErrorPagesNoInternetTitle", tableName: "BraveShared", bundle: .module, value: "No internet access", comment: "Title of the No Internet error page")

    static let errorPagesNoInternetTry = NSLocalizedString("ErrorPagesNoInternetTry", tableName: "BraveShared", bundle: .module, value: "It appears you're not online. To fix this, try", comment: "Text telling the user to Try: The following list of things")

    static let errorPagesNoInternetTryItem1 = NSLocalizedString("ErrorPagesNoInternetTryItem1", tableName: "BraveShared", bundle: .module, value: "Checking the network cables, modem, and router", comment: "List of things to try when internet is not working")

    static let errorPagesNoInternetTryItem2 = NSLocalizedString("ErrorPagesNoInternetTryItem2", tableName: "BraveShared", bundle: .module, value: "Reconnecting to Wi-Fi", comment: "List of things to try when internet is not working")

    static let errorPagesAdvancedErrorPinningDetails = NSLocalizedString("ErrorPagesAdvancedErrorPinningDetails", tableName: "BraveShared", bundle: .module, value: "%@ normally uses encryption to protect your information. When Browser tried to connect to %@ this time, the website sent back unusual and incorrect credentials. This may happen when an attacker is trying to pretend to be %@, or a Wi-Fi sign-in screen has interrupted the connection. Your information is still secure because Browser stopped the connection before any data was exchanged.<br />You cannot visit %@ right now because the website uses certificate pinning. Network errors and attacks are usually temporary, so this page will probably work later.", comment: "Additional warning text when clicking the Advanced button on error pages. %@ is a placeholder, do not localize it. Do not localize <br />.")
}

// MARK: - Sync

public extension Strings {
    static let QRCode = NSLocalizedString("QRCode", tableName: "BraveShared", bundle: .module, value: "QR Code", comment: "QR Code section title")
    static let codeWords = NSLocalizedString("CodeWords", tableName: "BraveShared", bundle: .module, value: "Code Words", comment: "Code words section title")
    static let sync = NSLocalizedString("Sync", tableName: "BraveShared", bundle: .module, value: "Sync", comment: "Sync settings section title")
    static let syncSettingsHeader = NSLocalizedString("SyncSettingsHeader", tableName: "BraveShared", bundle: .module, value: "The device list below includes all devices in your sync chain. Each device can be managed from any other device.", comment: "Header title for Sync settings")
    static let syncThisDevice = NSLocalizedString("SyncThisDevice", tableName: "BraveShared", bundle: .module, value: "This Device", comment: "This device cell")
    static let braveSync = NSLocalizedString("BraveSync", tableName: "BraveShared", bundle: .module, value: "Sync", comment: "Sync page title")
    static let braveSyncInternalsTitle = NSLocalizedString("BraveSyncInternalsTitle", tableName: "BraveShared", bundle: .module, value: "Sync Internals", comment: "Sync-Internals screen title (Sync Internals or Sync Debugging is fine).")
    static let braveSyncWelcome = NSLocalizedString("BraveSyncWelcome", tableName: "BraveShared", bundle: .module, value: "To start, you will need Browser installed on all the devices you plan to sync. To chain them together, start a sync chain that you will use to securely link all of your devices together.", comment: "Sync settings welcome")
    static let newSyncCode = NSLocalizedString("NewSyncCode", tableName: "BraveShared", bundle: .module, value: "Start a new Sync Chain", comment: "New sync code button title")
    static let scanSyncCode = NSLocalizedString("ScanSyncCode", tableName: "BraveShared", bundle: .module, value: "I have a Sync Code", comment: "Scan sync code button title")
    static let scan = NSLocalizedString("Scan", tableName: "BraveShared", bundle: .module, value: "Scan", comment: "Scan sync code title")
    static let syncChooseDevice = NSLocalizedString("SyncChooseDevice", tableName: "BraveShared", bundle: .module, value: "Choose Device Type", comment: "Choose device type for sync")
    static let syncAddDeviceScan = NSLocalizedString("SyncAddDeviceScan", tableName: "BraveShared", bundle: .module, value: "Sync Chain QR Code", comment: "Add mobile device to sync with scan")
    static let syncAddDeviceWords = NSLocalizedString("SyncAddDeviceWords", tableName: "BraveShared", bundle: .module, value: "Enter the sync code", comment: "Add device to sync with code words")
    static let syncAddDeviceWordsTitle = NSLocalizedString("SyncAddDeviceWordsTitle", tableName: "BraveShared", bundle: .module, value: "Enter Code Words", comment: "Add device to sync with code words navigation title")
    static let syncToDevice = NSLocalizedString("SyncToDevice", tableName: "BraveShared", bundle: .module, value: "Sync to device", comment: "Sync to existing device")
    static let syncToDeviceDescription = NSLocalizedString("SyncToDeviceDescription", tableName: "BraveShared", bundle: .module, value: "Using existing synced device open Settings and navigate to Settings -> Sync. Choose \"Add Device\" and scan the code displayed on the screen.", comment: "Sync to existing device description")

    static let syncAddDeviceScanDescription = NSLocalizedString("SyncAddDeviceScanDescription", tableName: "BraveShared", bundle: .module, value: "On your second mobile device, navigate to Sync in the Settings panel and tap the button \"Scan Sync Code\". Use your camera to scan the QR Code below.\n\n Treat this code like a password. If someone gets hold of it, they can read and modify your synced data.", comment: "Sync add device description")
    static let syncSwitchBackToCameraButton = NSLocalizedString("SyncSwitchBackToCameraButton", tableName: "BraveShared", bundle: .module, value: "I'll use my camera...", comment: "Switch back to camera button")
    static let syncAddDeviceWordsDescription = NSLocalizedString("SyncAddDeviceWordsDescription", tableName: "BraveShared", bundle: .module, value: "On your device, navigate to Sync in the Settings panel and tap the button \"%@\". Enter the sync chain code words shown below.\n\n Treat this code like a password. If someone gets hold of it, they can read and modify your synced data.", comment: "Sync add device description")
    static let syncNoConnectionTitle = NSLocalizedString("SyncNoConnectionTitle", tableName: "BraveShared", bundle: .module, value: "Can't connect to sync", comment: "No internet connection alert title.")
    static let syncNoConnectionBody = NSLocalizedString("SyncNoConnectionBody", tableName: "BraveShared", bundle: .module, value: "Check your internet connection and try again.", comment: "No internet connection alert body.")
    static let enterCodeWords = NSLocalizedString("EnterCodeWords", tableName: "BraveShared", bundle: .module, value: "Enter code words", comment: "Sync enter code words")
    static let showCodeWords = NSLocalizedString("ShowCodeWords", tableName: "BraveShared", bundle: .module, value: "Show code words instead", comment: "Show code words instead")
    static let syncDevices = NSLocalizedString("SyncDevices", tableName: "BraveShared", bundle: .module, value: "Devices & Settings", comment: "Sync you browser settings across devices.")
    static let devices = NSLocalizedString("Devices", tableName: "BraveShared", bundle: .module, value: "Devices on sync chain", comment: "Sync device settings page title.")
    static let codeWordInputHelp = NSLocalizedString("CodeWordInputHelp", tableName: "BraveShared", bundle: .module, value: "Type your supplied sync chain code words into the form below.", comment: "Code words input help")
    static let copyToClipboard = NSLocalizedString("CopyToClipboard", tableName: "BraveShared", bundle: .module, value: "Copy to Clipboard", comment: "Copy codewords title")
    static let copiedToClipboard = NSLocalizedString("CopiedToClipboard", tableName: "BraveShared", bundle: .module, value: "Copied to Clipboard!", comment: "Copied codewords title")
    ...
    static let copyCleanLink = NSLocalizedString(
    ...
    static let syncUnsuccessful = NSLocalizedString("SyncUnsuccessful", tableName: "BraveShared", bundle: .module, value: "Unsuccessful", comment: "")
    static let syncUnableCreateGroup = NSLocalizedString("SyncUnableCreateGroup", tableName: "BraveShared", bundle: .module, value: "Can't sync this device", comment: "Description on popup when setting up a sync group fails")
    static let copied = NSLocalizedString("Copied", tableName: "BraveShared", bundle: .module, value: "Copied!", comment: "Copied action complete title")
    static let wordCount = NSLocalizedString("WordCount", tableName: "BraveShared", bundle: .module, value: "Word count: %i", comment: "Word count title")
    static let unableToConnectTitle = NSLocalizedString("UnableToConnectTitle", tableName: "BraveShared", bundle: .module, value: "Unable to Connect", comment: "Sync Alert")
    static let unableToConnectDescription = NSLocalizedString("UnableToConnectDescription", tableName: "BraveShared", bundle: .module, value: "Unable to join sync group. Please check the entered words and try again.", comment: "Sync Alert")
    static let enterCodeWordsBelow = NSLocalizedString("EnterCodeWordsBelow", tableName: "BraveShared", bundle: .module, value: "Enter code words below", comment: "Enter sync code words below")
    static let syncRemoveThisDevice = NSLocalizedString("SyncRemoveThisDevice", tableName: "BraveShared", bundle: .module, value: "Remove this device", comment: "Sync remove device.")
    static let syncRemoveDeviceAction = NSLocalizedString("SyncRemoveDeviceAction", tableName: "BraveShared", bundle: .module, value: "Remove device", comment: "Remove device button for action sheet.")
    static let syncRemoveThisDeviceQuestion = NSLocalizedString("SyncRemoveThisDeviceQuestion", tableName: "BraveShared", bundle: .module, value: "Remove this device?", comment: "Sync remove device?")
    static let syncChooseDeviceHeader = NSLocalizedString("SyncChooseDeviceHeader", tableName: "BraveShared", bundle: .module, value: "Choose the type of device you would like to sync to.", comment: "Header for device choosing screen.")
    static let syncRemoveThisDeviceQuestionDesc = NSLocalizedString("SyncRemoveThisDeviceQuestionDesc", tableName: "BraveShared", bundle: .module, value: "This device will be disconnected from sync group and no longer receive or send sync data. All existing data will remain on device.", comment: "Sync remove device?")
    static let pair = NSLocalizedString("Pair", tableName: "BraveShared", bundle: .module, value: "Pair", comment: "Sync pair device settings section title")
    static let syncAddAnotherDevice = NSLocalizedString("SyncAddAnotherDevice", tableName: "BraveShared", bundle: .module, value: "Add New Device", comment: "Add New Device cell button.")
    static let syncDeleteAccount = NSLocalizedString("SyncDeleteAccount", tableName: "BraveShared", bundle: .module, value: "Delete Sync Account", comment: "Delete Sync Account cell title for button.")
    static let syncTabletOrMobileDevice = NSLocalizedString("SyncTabletOrMobileDevice", tableName: "BraveShared", bundle: .module, value: "Tablet or Phone", comment: "Tablet or phone button title")
    static let syncAddTabletOrPhoneTitle = NSLocalizedString("SyncAddTabletOrPhoneTitle", tableName: "BraveShared", bundle: .module, value: "Add a Tablet or Phone", comment: "Add Tablet or phone title")
    static let syncComputerDevice = NSLocalizedString("SyncComputerDevice", tableName: "BraveShared", bundle: .module, value: "Computer", comment: "Computer device button title")
    static let syncAddComputerTitle = NSLocalizedString("SyncAddComputerTitle", tableName: "BraveShared", bundle: .module, value: "Add a Computer", comment: "Add a Computer title")
    static let grantCameraAccess = NSLocalizedString("GrantCameraAccess", tableName: "BraveShared", bundle: .module, value: "Enable Camera", comment: "Grand camera access")
    static let removeDevice = NSLocalizedString("RemoveDevice", tableName: "BraveShared", bundle: .module, value: "Remove", comment: "Action button for removing sync device.")
    static let syncInitErrorTitle = NSLocalizedString("SyncInitErrorTitle", tableName: "BraveShared", bundle: .module, value: "Sync Communication Error", comment: "Title for sync initialization error alert")
    static let syncInitErrorMessage = NSLocalizedString("SyncInitErrorMessage", tableName: "BraveShared", bundle: .module, value: "The Sync Agent is currently offline or not reachable. Please try again later.", comment: "Message for sync initialization error alert")
    // Remove device popups
    static let syncRemoveLastDeviceTitle = NSLocalizedString("SyncRemoveLastDeviceTitle", tableName: "BraveShared", bundle: .module, value: "Removing %@ will delete the Sync Chain.", comment: "Title for removing last device from Sync")
    static let syncRemoveLastDeviceMessage = NSLocalizedString("SyncRemoveLastDeviceMessage", tableName: "BraveShared", bundle: .module, value: "Data currently synced will be retained but all data in Browser’s Sync cache will be deleted. You will need to start a new sync chain to sync device data again.", comment: "Message for removing last device from Sync")
    static let syncRemoveLastDeviceRemoveButtonName = NSLocalizedString("SyncRemoveLastDeviceRemoveButtonName", tableName: "BraveShared", bundle: .module, value: "Delete Sync Chain", comment: "Button name for removing last device from Sync")
    static let syncRemoveCurrentDeviceTitle = NSLocalizedString("SyncRemoveCurrentDeviceTitle", tableName: "BraveShared", bundle: .module, value: "Remove %@ from Sync Chain?", comment: "Title for removing the current device from Sync")
    static let syncRemoveCurrentDeviceMessage = NSLocalizedString("SyncRemoveCurrentDeviceMessage", tableName: "BraveShared", bundle: .module, value: "Local device data will remain intact on all devices. Other devices in this Sync Chain will remain synced. ", comment: "Message for removing the current device from Sync")
    static let syncRemoveOtherDeviceTitle = NSLocalizedString("SyncRemoveOtherDeviceTitle", tableName: "BraveShared", bundle: .module, value: "Remove %@ from Sync Chain?", comment: "Title for removing other device from Sync")
    static let syncRemoveOtherDeviceMessage = NSLocalizedString("SyncRemoveOtherDeviceMessage", tableName: "BraveShared", bundle: .module, value: "Removing the device from the Sync Chain will not clear previously synced data from the device.", comment: "Message for removing other device from Sync")
    static let syncRemoveDeviceDefaultName = NSLocalizedString("SyncRemoveDeviceDefaultName", tableName: "BraveShared", bundle: .module, value: "Device", comment: "Default name for a device")
    static let syncValidForTooLongError = NSLocalizedString("syncValidForTooLongError", tableName: "BraveShared", bundle: .module, value: "This code is invalid. Please check that the time and timezone are set correctly on your device.", comment: "Sync Error Description")
    static let syncDeprecatedVersionError = NSLocalizedString("syncDeprecatedVersionError", tableName: "BraveShared", bundle: .module, value: "This sync code was generated by an outdated version of Browser on another device. Please update Browser on all synced devices and try again.", comment: "Sync Error Description")
    static let syncExpiredError = NSLocalizedString("syncExpiredError", tableName: "BraveShared", bundle: .module, value: "This sync code has expired, please generate a new sync code and try again.", comment: "Sync Error message for when the sync code is expired")
    static let syncGenericError = NSLocalizedString("syncGenericError", tableName: "BraveShared", bundle: .module, value: "Sorry, something went wrong", comment: "Generic Sync Error Description")
    static let notEnoughWordsTitle = NSLocalizedString("NotEnoughWordsTitle", tableName: "BraveShared", bundle: .module, value: "Not Enough Words", comment: "Error title for when the sync code does not have the correct amount of words")
    static let notEnoughWordsDescription = NSLocalizedString("NotEnoughWordsDescription", tableName: "BraveShared", bundle: .module, value: "Please enter all of the words and try again.", comment: "Error message for when the sync code does not have the correct amount of words")
    static let invalidSyncCodeDescription = NSLocalizedString("InvalidSyncCodeDescription", tableName: "BraveShared", bundle: .module, value: "Invalid sync code, please check and try again.", comment: "Generic error message for when the sync code is invalid")
}

public extension Strings {
    static let home = NSLocalizedString("Home", tableName: "BraveShared", bundle: .module, value: "Home", comment: "")
    static let clearingData = NSLocalizedString("ClearData", tableName: "BraveShared", bundle: .module, value: "Clearing Data", comment: "")
}

public extension Strings {
    static let newFolder = NSLocalizedString("NewFolder", tableName: "BraveShared", bundle: .module, value: "New Folder", comment: "Title for new folder popup")
    static let enterFolderName = NSLocalizedString("EnterFolderName", tableName: "BraveShared", bundle: .module, value: "Enter folder name", comment: "Description for new folder popup")
    static let edit = NSLocalizedString("Edit", tableName: "BraveShared", bundle: .module, value: "Edit", comment: "")

    static let currentlyUsedSearchEngines = NSLocalizedString("CurrentlyUsedSearchEngines", tableName: "BraveShared", bundle: .module, value: "Currently used search engines", comment: "Currently usedd search engines section name.")
    static let quickSearchEngines = NSLocalizedString("QuickSearchEngines", tableName: "BraveShared", bundle: .module, value: "Quick-Search Engines", comment: "Title for quick-search engines settings section.")
    static let customSearchEngines = NSLocalizedString("CustomSearchEngines", tableName: "BraveShared", bundle: .module, value: "Custom-Search Engines", comment: "Title for quick-search engines settings section.")
    static let plugEngine = NSLocalizedString("PlugEngine", tableName: "BraveShared", bundle: .module, value: "Plugs", comment: "搜索引擎附加组件.")
    
    
    static let standardTabSearch = NSLocalizedString("StandardTabSearch", tableName: "BraveShared", bundle: .module, value: "Standard Tab", comment: "Open search section of settings")
    static let privateTabSearch = NSLocalizedString("PrivateTabSearch", tableName: "BraveShared", bundle: .module, value: "Private Tab", comment: "Default engine for private search.")
    static let searchEngines = NSLocalizedString("SearchEngines", tableName: "BraveShared", bundle: .module, value: "Search Engines", comment: "Search engines section of settings")
    static let settings = NSLocalizedString("Settings", tableName: "BraveShared", bundle: .module, value: "Settings", comment: "")
    static let done = NSLocalizedString("Done", tableName: "BraveShared", bundle: .module, value: "Done", comment: "")
    static let confirm = NSLocalizedString("Confirm", tableName: "BraveShared", bundle: .module, value: "Confirm", comment: "")
    static let privacy = NSLocalizedString("Privacy", tableName: "BraveShared", bundle: .module, value: "Privacy", comment: "Settings privacy section title")
    static let security = NSLocalizedString("Security", tableName: "BraveShared", bundle: .module, value: "Security", comment: "Settings security section title")
    static let saveLogins = NSLocalizedString("SaveLogins", tableName: "BraveShared", bundle: .module, value: "Save Logins", comment: "Setting to enable the built-in password manager")
    static let showBookmarkButtonInTopToolbar = NSLocalizedString("ShowBookmarkButtonInTopToolbar", tableName: "BraveShared", bundle: .module, value: "Show Bookmarks Shortcut", comment: "Setting to show a bookmark button on the top level menu that triggers a panel of the user's bookmarks.")
    static let alwaysRequestDesktopSite = NSLocalizedString("AlwaysRequestDesktopSite", tableName: "BraveShared", bundle: .module, value: "Always Request Desktop Site", comment: "Setting to always request the desktop version of a website.")
    static let delete = NSLocalizedString("Delete", tableName: "BraveShared", bundle: .module, value: "Delete", comment: "")

    static let newTab = NSLocalizedString("NewTab", tableName: "BraveShared", bundle: .module, value: "New Tab", comment: "New Tab title")
    static let yes = NSLocalizedString("Yes", tableName: "BraveShared", bundle: .module, comment: "For search suggestions prompt. This string should be short so it fits nicely on the prompt row.")
    static let no = NSLocalizedString("No", tableName: "BraveShared", bundle: .module, comment: "For search suggestions prompt. This string should be short so it fits nicely on the prompt row.")
    static let openAllBookmarks = NSLocalizedString("OpenAllBookmarks", tableName: "BraveShared", bundle: .module, value: "Open All (%i)", comment: "Context menu item for opening all folder bookmarks")

    static let bookmarkFolder = NSLocalizedString("BookmarkFolder", tableName: "BraveShared", bundle: .module, value: "Bookmark Folder", comment: "Bookmark Folder Section Title")
    static let bookmarkInfo = NSLocalizedString("BookmarkInfo", tableName: "BraveShared", bundle: .module, value: "Bookmark Info", comment: "Bookmark Info Section Title")
    static let name = NSLocalizedString("Name", tableName: "BraveShared", bundle: .module, value: "Name", comment: "Bookmark title / Device name")
    static let URL = NSLocalizedString("URL", tableName: "BraveShared", bundle: .module, value: "URL", comment: "Bookmark URL")
    static let bookmarks = NSLocalizedString("Bookmarks", tableName: "BraveShared", bundle: .module, value: "Bookmarks", comment: "title for bookmarks panel")
    static let today = NSLocalizedString("Today", tableName: "BraveShared", bundle: .module, value: "Today", comment: "History tableview section header")
    static let yesterday = NSLocalizedString("Yesterday", tableName: "BraveShared", bundle: .module, value: "Yesterday", comment: "History tableview section header")
    static let lastWeek = NSLocalizedString("LastWeek", tableName: "BraveShared", bundle: .module, value: "Last week", comment: "History tableview section header")
    static let lastMonth = NSLocalizedString("LastMonth", tableName: "BraveShared", bundle: .module, value: "Last month", comment: "History tableview section header")
    static let earlier = NSLocalizedString("Earlier", tableName: "BraveShared", bundle: .module, value: "Earlier", comment: "History tableview section header that indicated history items earlier than last month")
    static let savedLogins = NSLocalizedString("SavedLogins", tableName: "BraveShared", bundle: .module, value: "Saved Logins", comment: "Settings item for clearing passwords and login data")
    static let downloadedFiles = NSLocalizedString("DownloadedFiles", tableName: "BraveShared", bundle: .module, value: "Downloaded files", comment: "Settings item for clearing downloaded files.")
    static let browsingHistory = NSLocalizedString("BrowsingHistory", tableName: "BraveShared", bundle: .module, value: "Browsing History", comment: "Settings item for clearing browsing history")
    static let cache = NSLocalizedString("Cache", tableName: "BraveShared", bundle: .module, value: "Cache", comment: "Settings item for clearing the cache")
    static let cookies = NSLocalizedString("Cookies", tableName: "BraveShared", bundle: .module, value: "Cookies and Site Data", comment: "Settings item for clearing cookies and site data")
    static let findInPage = NSLocalizedString("FindInPage", tableName: "BraveShared", bundle: .module, value: "Find in Page", comment: "Share action title")
    static let searchWithBrave = NSLocalizedString("SearchWithBrave", tableName: "BraveShared", bundle: .module, value: "Search with Browser", comment: "Title of an action that allows user to perform a one-click web search for selected text")
    static let forcePaste = NSLocalizedString("ForcePaste", tableName: "BraveShared", bundle: .module, value: "Force Paste", comment: "A label which when tapped pastes from the users clipboard forcefully (so as to ignore any paste restrictions placed by the website)")
    static let addToFavorites = NSLocalizedString("AddToFavorites", tableName: "BraveShared", bundle: .module, value: "Add to Favorites", comment: "Add to favorites share action.")
    static let createPDF = NSLocalizedString("CreatePDF", tableName: "BraveShared", bundle: .module, value: "Create PDF", comment: "Create PDF share action.")
    static let displayCertificate = NSLocalizedString("DisplayCertificate", tableName: "BraveShared", bundle: .module, value: "Security Certificate", comment: "Button title that when tapped displays a websites HTTPS security certificate information")
    static let toggleReaderMode = NSLocalizedString("ToggleReaderMode", tableName: "BraveShared", bundle: .module, value: "Toggle Reader Mode", comment: "Button title that when tapped toggles the web page in our out of reader mode")

    static let showBookmarks = NSLocalizedString("ShowBookmarks", tableName: "BraveShared", bundle: .module, value: "Show Bookmarks", comment: "Button to show the bookmarks list")
    static let showHistory = NSLocalizedString("ShowHistory", tableName: "BraveShared", bundle: .module, value: "Show History", comment: "Button to show the history list")
    static let addBookmark = NSLocalizedString("AddBookmark", tableName: "BraveShared", bundle: .module, value: "Add Bookmark", comment: "Button to add a bookmark")
    static let editBookmark = NSLocalizedString("EditBookmark", tableName: "BraveShared", bundle: .module, value: "Edit Bookmark", comment: "Button to edit a bookmark")
    static let editFavorite = NSLocalizedString("EditFavorite", tableName: "BraveShared", bundle: .module, value: "Edit Favorite", comment: "Button to edit a favorite")
    static let removeFavorite = NSLocalizedString("RemoveFavorite", tableName: "BraveShared", bundle: .module, value: "Remove Favorite", comment: "Button to remove a favorite")

    static let deleteBookmarksFolderAlertTitle = NSLocalizedString("DeleteBookmarksFolderAlertTitle", tableName: "BraveShared", bundle: .module, value: "Delete Folder?", comment: "Title for the alert shown when the user tries to delete a bookmarks folder")
    static let deleteBookmarksFolderAlertMessage = NSLocalizedString("DeleteBookmarksFolderAlertMessage", tableName: "BraveShared", bundle: .module, value: "This will delete all folders and bookmarks inside. Are you sure you want to continue?", comment: "Message for the alert shown when the user tries to delete a bookmarks folder")
    static let yesDeleteButtonTitle = NSLocalizedString("YesDeleteButtonTitle", tableName: "BraveShared", bundle: .module, value: "Yes, Delete", comment: "Button title to confirm the deletion of a bookmarks folder")

    static let close = NSLocalizedString("Close", tableName: "BraveShared", bundle: .module, value: "Close", comment: "Button title to close a menu.")
    static let openWebsite = NSLocalizedString("OpenWebsite", tableName: "BraveShared", bundle: .module, value: "Open Website", comment: "Button title to that opens a website.")
    static let viewOn = NSLocalizedString("ViewOn", tableName: "BraveShared", bundle: .module, value: "View on %@", comment: "Label that says where to view an item. '%@' is a placeholder and will include things like 'Instagram', 'unsplash'. The full label will look like 'View  on Instagram'.")
    static let photoBy = NSLocalizedString("PhotoBy", tableName: "BraveShared", bundle: .module, value: "Photo by %@", comment: "Label that says who took a photograph that will be displayed to the user. '%@' is a placeholder and will include be a specific person's name, example 'Bill Gates'.")

    static let features = NSLocalizedString("Features", tableName: "BraveShared", bundle: .module, value: "Features", comment: "")

    static let braveShieldsAndPrivacy = NSLocalizedString("BraveShieldsAndPrivacy", tableName: "BraveShared", bundle: .module, value: "Browser Shields & Privacy", comment: "")
    static let bookmarksImportAction = NSLocalizedString("bookmarksImportAction", tableName: "BraveShared", bundle: .module, value: "Import Bookmarks", comment: "Action to import bookmarks from a file.")
    static let bookmarksExportAction = NSLocalizedString("bookmarksExportAction", tableName: "BraveShared", bundle: .module, value: "Export Bookmarks", comment: "Action to export bookmarks to another device.")
}

public extension Strings {
    static let blockPopups = NSLocalizedString("BlockPopups", tableName: "BraveShared", bundle: .module, value: "Block Popups", comment: "Setting to enable popup blocking")
    static let followUniversalLinks = NSLocalizedString("FollowUniversalLinks", tableName: "BraveShared", bundle: .module, value: "Allow universal links to open in external apps", comment: "Setting to follow universal links")
    static let mediaAutoBackgrounding = NSLocalizedString("MediaAutoBackgrounding", tableName: "BraveShared", bundle: .module, value: "Enable Background Audio", comment: "Setting to allow media to play in the background")
    static let youtubeMediaQualitySettingsTitle = NSLocalizedString("YoutubeMediaQualitySettingsTitle", tableName: "BraveShared", bundle: .module, value: "Youtube Playback Quality", comment: "Title for youtube playback quality settings")
    static let youtubeMediaQuality = NSLocalizedString("YoutubeMediaQuality", tableName: "BraveShared", bundle: .module, value: "Enable High-Quality Youtube Videos", comment: "Setting to enable high quality youtube videos")
    static let youtubeMediaQualityDetails = NSLocalizedString("YoutubeMediaQualityDetails", tableName: "BraveShared", bundle: .module, value: "Enabling this experimental feature will playback video at the maximum quality available and will use additional data.", comment: "Description of setting to enable high quality youtube videos")
    static let youtubeMediaQualityOff = NSLocalizedString("YoutubeMediaQualityOff", tableName: "BraveShared", bundle: .module, value: "Off", comment: "Setting that disables highest quality video playback")
    static let youtubeMediaQualityWifi = NSLocalizedString("YoutubeMediaQualityWifi", tableName: "BraveShared", bundle: .module, value: "Allow over Wi-Fi", comment: "Setting that enables high quality playback on wifi only")
    static let youtubeMediaQualityOn = NSLocalizedString("YoutubeMediaQualityOn", tableName: "BraveShared", bundle: .module, value: "On", comment: "Setting that enables high quality playback always")
    static let showTabsBar = NSLocalizedString("ShowTabsBar", tableName: "BraveShared", bundle: .module, value: "Tabs Bar", comment: "Setting to show/hide the tabs bar")
    static let privateBrowsingOnly = NSLocalizedString("PrivateBrowsingOnly", tableName: "BraveShared", bundle: .module, value: "Private Browsing Only", comment: "Setting to keep app in private mode")
    static let persistentPrivateBrowsingAlertTitle = NSLocalizedString("PersistentPrivateBrowsingAlertTitle", tableName: "BraveShared", bundle: .module, value: "Restore Private Tabs", comment: "Persistent private browsing alert title to existing users")
    static let persistentPrivateBrowsingAlertMessage = NSLocalizedString("PersistentPrivateBrowsingAlertMessage", tableName: "BraveShared", bundle: .module, value: "Allows Browser to restore private browsing tabs, even if you close / re-open the app", comment: "Persistent private browsing alert message to existing users")
    static let persistentPrivateBrowsing = NSLocalizedString("PersistentPrivateBrowsing", tableName: "BraveShared", bundle: .module, value: "Persistent Private Browsing", comment: "Setting to allow the app to restore private browsing tabs")
    static let shieldsDefaults = NSLocalizedString("ShieldsDefaults", tableName: "BraveShared", bundle: .module, value: "Browser Shields Global Defaults", comment: "Section title for adbblock, tracking protection, HTTPS-E, and cookies")
    static let shieldsDefaultsFooter = NSLocalizedString("ShieldsDefaultsFooter", tableName: "BraveShared", bundle: .module, value: "These are the default Shields settings for new sites. Changing these won't affect your existing per-site settings.", comment: "Section footer for global shields defaults")
    static let HTTPSEverywhere = NSLocalizedString("HTTPSEverywhere", tableName: "BraveShared", bundle: .module, value: "Upgrade Connections to HTTPS", comment: "")
    static let HTTPSEverywhereDescription = NSLocalizedString("HTTPSEverywhereDescription", tableName: "BraveShared", bundle: .module, value: "Opens sites using secure HTTPS instead of HTTP when possible.", comment: "")
    static let googleSafeBrowsing = NSLocalizedString("GoogleSafeBrowsing", tableName: "BraveShared", bundle: .module, value: "Block Dangerous Websites", comment: "")
    static let googleSafeBrowsingUsingWebKitDescription = NSLocalizedString("GoogleSafeBrowsingUsingWebKitDescription", tableName: "BraveShared", bundle: .module, value: "Safe Browsing protects against websites which are known to be dangerous. [Learn More](%@)", comment: "")
    static let screenTimeSetting = NSLocalizedString("settings.privacy.screenTimeSetting", tableName: "BraveShared", bundle: .module, value: "Enable Screen Time", comment: "")
    static let screenTimeSettingDescription = NSLocalizedString("settings.privacy.screenTimeSettingDescription", tableName: "BraveShared", bundle: .module, value: "See which websites you spend the most time on, and set browsing limits. [Learn More](%@)", comment: "")
    static let blockScripts = NSLocalizedString("BlockScripts", tableName: "BraveShared", bundle: .module, value: "Block Scripts", comment: "")
    static let blockScriptsDescription = NSLocalizedString("BlockScriptsDescription", tableName: "BraveShared", bundle: .module, value: "Blocks JavaScript (may break sites).", comment: "")
    static let blockCookiesDescription = NSLocalizedString("BlockCookiesDescription", tableName: "BraveShared", bundle: .module, value: "Prevents websites from storing information about your previous visits.", comment: "")
    static let fingerprintingProtection = NSLocalizedString("FingerprintingProtection", tableName: "BraveShared", bundle: .module, value: "Block Fingerprinting", comment: "")
    static let fingerprintingProtectionDescription = NSLocalizedString("FingerprintingProtectionDescription", tableName: "BraveShared", bundle: .module, value: "Makes it harder for sites to recognize your device's distinctive characteristics. ", comment: "")
    static let autoRedirectAMPPages = NSLocalizedString("AutoRedirectAMPPages", tableName: "BraveShared", bundle: .module, value: "Auto-Redirect AMP Pages", comment: "This is a title for a setting toggle that enables/disables auto-redirect of Google's AMP (Accelerated Mobile Page) pages to the original (non-AMP) pages. The text 'AMP' is not to be translated.")
    static let autoRedirectAMPPagesDescription = NSLocalizedString("AutoRedirectAMPPagesDescription", tableName: "BraveShared", bundle: .module, value: "Always visit original (non-AMP) page URLs, instead of Google's Accelerated Mobile Page versions", comment: "This is a description for a setting toggle that enables/disables auto-redirect of Google's AMP (Accelerated Mobile Page) pages to the original (non-AMP) pages. The text 'AMP' and 'Accelerated Mobile Page' is not to be translated.")
    static let autoRedirectTrackingURLs = NSLocalizedString("AutoRedirectTrackingURLs", tableName: "BraveShared", bundle: .module, value: "Auto-Redirect Tracking URLs", comment: "This is a title for a setting toggle that enables/disables auto-redirection of tracking pages (Debouncing). Debouncing skips certain intermediate tracker pages and goes directly to the target without the intermediate tracker page.")
    static let autoRedirectTrackingURLsDescription = NSLocalizedString("AutoRedirectTrackingURLsDescription", tableName: "BraveShared", bundle: .module, value: "Enable support for bypassing top-level redirect tracking URLs", comment: "This is a description for a setting toggle that enables/disables auto-redirect of tracking URLs (i.e. Debouncing).")
    static let support = NSLocalizedString("Support", tableName: "BraveShared", bundle: .module, value: "Support", comment: "Support section title")
    static let about = NSLocalizedString("About", tableName: "BraveShared", bundle: .module, value: "About", comment: "About settings section title")
    static let versionTemplate = NSLocalizedString("VersionTemplate", tableName: "BraveShared", bundle: .module, value: "Version %@ (%@)", comment: "Version number of Browser shown in settings")
    static let deviceTemplate = NSLocalizedString("DeviceTemplate", tableName: "BraveShared", bundle: .module, value: "Device %@ (%@)", comment: "Current device model and iOS version copied to clipboard.")
    static let copyAppInfoToClipboard = NSLocalizedString("CopyAppInfoToClipboard", tableName: "BraveShared", bundle: .module, value: "Copy app info to clipboard.", comment: "Copy app info to clipboard action sheet action.")
    static let copyAppSizeInfoToClipboard =
    ...
    static let blockThirdPartyCookies = NSLocalizedString("Block3rdPartyCookies", tableName: "BraveShared", bundle: .module, value: "Block 3rd party cookies", comment: "cookie settings option")
    static let blockAllCookies = NSLocalizedString("BlockAllCookies", tableName: "BraveShared", bundle: .module, value: "Block all Cookies", comment: "Title for setting to block all website cookies.")
    static let blockAllCookiesAction = NSLocalizedString("BlockAllCookiesAction", tableName: "BraveShared", bundle: .module, value: "Block All", comment: "block all cookies settings action title")
    static let blockAllCookiesAlertInfo = NSLocalizedString("BlockAllCookiesAlertInfo", tableName: "BraveShared", bundle: .module, value: "Blocking all Cookies will prevent some websites from working correctly.", comment: "Information displayed to user when block all cookie is enabled.")
    static let blockAllCookiesAlertTitle = NSLocalizedString("BlockAllCookiesAlertTitle", tableName: "BraveShared", bundle: .module, value: "Block all Cookies?", comment: "Title of alert displayed to user when block all cookie is enabled.")
    static let blockAllCookiesFailedAlertMsg = NSLocalizedString("BlockAllCookiesFailedAlertMsg", tableName: "BraveShared", bundle: .module, value: "Failed to set the preference. Please try again.", comment: "Message of alert displayed to user when block all cookie operation fails")
    static let dontBlockCookies = NSLocalizedString("DontBlockCookies", tableName: "BraveShared", bundle: .module, value: "Don't block cookies", comment: "cookie settings option")
    static let cookieControl = NSLocalizedString("CookieControl", tableName: "BraveShared", bundle: .module, value: "Cookie Control", comment: "Cookie settings option title")
    static let neverShow = NSLocalizedString("NeverShow", tableName: "BraveShared", bundle: .module, value: "Off", comment: "Setting preference to always hide the browser tabs bar.")
    static let alwaysShow = NSLocalizedString("AlwaysShow", tableName: "BraveShared", bundle: .module, value: "On", comment: "Setting preference to always show the browser tabs bar.")
    static let showInLandscapeOnly = NSLocalizedString("ShowInLandscapeOnly", tableName: "BraveShared", bundle: .module, value: "Landscape Only", comment: "Setting preference to only show the browser tabs bar when the device is in the landscape orientation.")
    static let rateBrave = NSLocalizedString("RateBrave", tableName: "BraveShared", bundle: .module, value: "Rate Browser", comment: "Open the App Store to rate Browser.")
    static let reportABug = NSLocalizedString("ReportABug", tableName: "BraveShared", bundle: .module, value: "Report a Bug", comment: "Providers the user an email page where they can submit a but report.")
    static let privacyPolicy = NSLocalizedString("PrivacyPolicy", tableName: "BraveShared", bundle: .module, value: "Privacy Policy", comment: "Show Browser Browser Privacy Policy page from the Privacy section in the settings.")
    static let termsOfUse = NSLocalizedString("TermsOfUse", tableName: "BraveShared", bundle: .module, value: "Terms of Use", comment: "Show Browser Browser TOS page from the Privacy section in the settings.")
    static let privateTabBody = NSLocalizedString("PrivateTabBody", tableName: "BraveShared", bundle: .module, value: "Private Tabs aren’t saved in Browser, but they don’t make you anonymous online. Sites you visit in a private tab won’t show up in your history and their cookies always vanish when you close them — there won’t be any trace of them left in Browser. However, downloads will be saved.\nYour mobile carrier (or the owner of the Wi-Fi network or VPN you’re connected to) can see which sites you visit and those sites will learn your public IP address, even in Private Tabs.", comment: "Private tab details")
    static let privateTabDetails = NSLocalizedString(
        "PrivateTabDetails", tableName: "BraveShared", bundle: .module,
        value:
        "Using Private Tabs only changes what Browser does on your device, it doesn't change anyone else's behavior.\n\nSites always learn your IP address when you visit them. From this, they can often guess roughly where you are — typically your city. Sometimes that location guess can be much more specific. Sites also know everything you specifically tell them, such as search terms. If you log into a site, they'll know you're the owner of that account. You'll still be logged out when you close the Private Tabs because Browser will throw away the cookie which keeps you logged in.\n\nWhoever connects you to the Internet (your ISP) can see all of your network activity. Often, this is your mobile carrier. If you're connected to a Wi-Fi network, this is the owner of that network, and if you're using a VPN, then it's whoever runs that VPN. Your ISP can see which sites you visit as you visit them. If those sites use HTTPS, they can't make much more than an educated guess about what you do on those sites. But if a site only uses HTTP then your ISP can see everything: your search terms, which pages you read, and which links you follow.\n\nIf an employer manages your device, they might also keep track of what you do with it. Using Private Tabs probably won't stop them from knowing which sites you've visited. Someone else with access to your device could also have installed software which monitors your activity, and Private Tabs won't protect you from this either.",
        comment: "Private tab detail text")
    static let privateTabLink = NSLocalizedString("PrivateTabLink", tableName: "BraveShared", bundle: .module, value: "Learn about Private Tabs.", comment: "Private tab information link")
    static let privateBrowsingOnlyWarning = NSLocalizedString("PrivateBrowsingOnlyWarning", tableName: "BraveShared", bundle: .module, value: "Private Browsing Only mode will close all your current tabs and log you out of all sites.", comment: "When 'Private Browsing Only' is enabled, we need to alert the user of their normal tabs being destroyed")
    static let bravePanel = NSLocalizedString("BravePanel", tableName: "BraveShared", bundle: .module, value: "Browser Panel", comment: "Button to show the Browser panel")
    static let rewardsPanel = NSLocalizedString("RewardsPanel", tableName: "BraveShared", bundle: .module, value: "Rewards Panel", comment: "Button to show the rewards panel")
    static let individualControls = NSLocalizedString("IndividualControls", tableName: "BraveShared", bundle: .module, value: "Individual Controls", comment: "title for per-site shield toggles")
    static let blockingMonitor = NSLocalizedString("BlockingMonitor", tableName: "BraveShared", bundle: .module, value: "Blocking Monitor", comment: "title for section showing page blocking statistics")
    static let siteShieldSettings = NSLocalizedString("SiteShieldSettings", tableName: "BraveShared", bundle: .module, value: "Shields", comment: "Browser panel topmost title")
    static let adsAndTrackers = NSLocalizedString("AdsAndTrackers", tableName: "BraveShared", bundle: .module, value: "Ads and Trackers", comment: "individual blocking statistic title")
    static let HTTPSUpgrades = NSLocalizedString("HTTPSUpgrades", tableName: "BraveShared", bundle: .module, value: "HTTPS Upgrades", comment: "individual blocking statistic title")
    static let scriptsBlocked = NSLocalizedString("ScriptsBlocked", tableName: "BraveShared", bundle: .module, value: "Scripts Blocked", comment: "individual blocking statistic title")
    static let fingerprintingMethods = NSLocalizedString("FingerprintingMethods", tableName: "BraveShared", bundle: .module, value: "Fingerprinting Methods", comment: "individual blocking statistic title")
    static let shieldsOverview = NSLocalizedString("ShieldsOverview", tableName: "BraveShared", bundle: .module, value: "Site Shields allow you to control when ads and trackers are blocked for each site that you visit. If you prefer to see ads on a specific site, you can enable them here.", comment: "shields overview message")
    static let shieldsOverviewFooter = NSLocalizedString("ShieldsOverviewFooter", tableName: "BraveShared", bundle: .module, value: "Note: Some sites may require scripts to work properly so this shield is turned off by default.", comment: "shields overview footer message")
    static let useRegionalAdblock = NSLocalizedString("UseRegionalAdblock", tableName: "BraveShared", bundle: .module, value: "Use regional adblock", comment: "Setting to allow user in non-english locale to use adblock rules specifc to their language")
    static let newFolderDefaultName = NSLocalizedString("NewFolderDefaultName", tableName: "BraveShared", bundle: .module, value: "New Folder", comment: "Default name for creating a new folder.")
    static let newBookmarkDefaultName = NSLocalizedString("NewBookmarkDefaultName", tableName: "BraveShared", bundle: .module, value: "New Bookmark", comment: "Default name for creating a new bookmark.")
    static let bookmarkTitlePlaceholderText = NSLocalizedString("BookmarkTitlePlaceholderText", tableName: "BraveShared", bundle: .module, value: "Name", comment: "Placeholder text for adding or editing a bookmark")
    static let bookmarkUrlPlaceholderText = NSLocalizedString("BookmarkUrlPlaceholderText", tableName: "BraveShared", bundle: .module, value: "Address", comment: "Placeholder text for adding or editing a bookmark")
    static let favoritesLocationFooterText = NSLocalizedString("FavoritesLocationFooterText", tableName: "BraveShared", bundle: .module, value: "Favorites are located on your home screen. These bookmarks are not synchronized with other devices.", comment: "Footer text when user selects to save to favorites when editing a bookmark")
    static let bookmarkRootLevelCellTitle = NSLocalizedString("BookmarkRootLevelCellTitle", tableName: "BraveShared", bundle: .module, value: "Bookmarks", comment: "Title for root level bookmarks cell")
    static let favoritesRootLevelCellTitle = NSLocalizedString("FavoritesRootLevelCellTitle", tableName: "BraveShared", bundle: .module, value: "Favorites", comment: "Title for favorites cell")
    static let addFolderActionCellTitle = NSLocalizedString("AddFolderActionCellTitle", tableName: "BraveShared", bundle: .module, value: "New folder", comment: "Cell title for add folder action")
    static let editBookmarkTableLocationHeader = NSLocalizedString("EditBookmarkTableLocationHeader", tableName: "BraveShared", bundle: .module, value: "Location", comment: "Header title for bookmark save location")
    static let newBookmarkTitle = NSLocalizedString("NewBookmarkTitle", tableName: "BraveShared", bundle: .module, value: "New bookmark", comment: "Title for adding new bookmark")
    static let newFolderTitle = NSLocalizedString("NewFolderTitle", tableName: "BraveShared", bundle: .module, value: "New folder", comment: "Title for adding new folder")
    static let editBookmarkTitle = NSLocalizedString("EditBookmarkTitle", tableName: "BraveShared", bundle: .module, value: "Edit bookmark", comment: "Title for editing a bookmark")
    static let editFavoriteTitle = NSLocalizedString("EditFavoriteTitle", tableName: "BraveShared", bundle: .module, value: "Edit favorite", comment: "Title for editing a favorite bookmark")
    static let editFolderTitle = NSLocalizedString("EditFolderTitle", tableName: "BraveShared", bundle: .module, value: "Edit folder", comment: "Title for editing a folder")
    static let historyScreenTitle = NSLocalizedString("HistoryScreenTitle", tableName: "BraveShared", bundle: .module, value: "History", comment: "Title for history screen")
    static let bookmarksMenuItem = NSLocalizedString("BookmarksMenuItem", tableName: "BraveShared", bundle: .module, value: "Bookmarks", comment: "Title for bookmarks menu item")
    static let historyMenuItem = NSLocalizedString("HistortMenuItem", tableName: "BraveShared", bundle: .module, value: "History", comment: "Title for history menu item")
    static let settingsMenuItem = NSLocalizedString("SettingsMenuItem", tableName: "BraveShared", bundle: .module, value: "Settings", comment: "Title for settings menu item")
    static let passwordsMenuItem = NSLocalizedString("PasswordsMenuItem", tableName: "BraveShared", bundle: .module, value: "Passwords", comment: "Title for passwords menu item")
    static let addToMenuItem = NSLocalizedString("AddToMenuItem", tableName: "BraveShared", bundle: .module, value: "Add Bookmark", comment: "Title for the button to add a new website bookmark.")
    static let openTabsMenuItem = NSLocalizedString("OpenTabsMenuItem", tableName: "BraveShared", bundle: .module, value: "Open Tabs", comment: "Title for open tabs menu item")
    static let shareWithMenuItem = NSLocalizedString("ShareWithMenuItem", tableName: "BraveShared", bundle: .module, value: "Share with...", comment: "Title for sharing url menu item")
    static let openExternalAppURLGenericTitle = NSLocalizedString("ExternalAppURLAlertTitle", tableName: "BraveShared", bundle: .module, value: "Allow link to switch apps?", comment: "Allow link to switch apps?")
    static let openExternalAppURLTitle = NSLocalizedString("openExternalAppURLTitle", tableName: "BraveShared", bundle: .module, value: "Allow %@ to switch apps?", comment: "This will be used to indicate which website is calling the action. %@ will replace the name of the website for instance: 'Allow google.com to switch apps?'")
    static let openExternalAppURLMessage = NSLocalizedString("ExternalAppURLAlertMessage", tableName: "BraveShared", bundle: .module, value: "%@ will launch an external application", comment: "%@ will launch an external application")
    static let openExternalAppURLHost = NSLocalizedString("openExternalAppURLHost", tableName: "BraveShared", bundle: .module, value: "%@ says:", comment: "This will be used to indicate which website is calling the action. %s will replace the name of the website for instance: 'google.com says:'")
    static let openExternalAppURLAllow = NSLocalizedString("ExternalAppURLAllow", tableName: "BraveShared", bundle: .module, value: "Allow", comment: "Allow Browser to open the external app URL")
    static let openExternalAppURLDontAllow = NSLocalizedString("ExternalAppURLDontAllow", tableName: "BraveShared", bundle: .module, value: "Don't Allow", comment: "Don't allow Browser to open the external app URL")
    static let requestCameraPermissionPrompt = NSLocalizedString("requestCameraPermissionPrompt", tableName: "BraveShared", bundle: .module, value: "\"%@\" Would Like to Access the Camera", comment: "A title that appears on a permissions dialog on whether or not the user wants to allow a web page to access their device's camera. %@ will be replaced with the websites address (for example: \"talk.Browser.com\")")
    static let requestMicrophonePermissionPrompt = NSLocalizedString("requestMicrophonePermissionPrompt", tableName: "BraveShared", bundle: .module, value: "\"%@\" Would Like to Access the Microphone", comment: "A title that appears on a permissions dialog on whether or not the user wants to allow a web page to access their device's microphone. %@ will be replaced with the websites address (for example: \"talk.Browser.com\")")
    static let requestCameraAndMicrophonePermissionPrompt = NSLocalizedString("requestCameraAndMicrophonePermissionPrompt", tableName: "BraveShared", bundle: .module, value: "\"%@\" Would Like to Access the Camera and Microphone", comment: "A title that appears on a permissions dialog on whether or not the user wants to allow a web page to access their device's camera & microphone. %@ will be replaced with the websites address (for example: \"talk.Browser.com\")")
    static let requestCaptureDevicePermissionPrompt = NSLocalizedString("requestCaptureDevicePermissionPrompt", tableName: "BraveShared", bundle: .module, value: "\"%@\" Would Like to Access a Media Capture Device", comment: "A title that appears on a permissions dialog on whether or not the user wants to allow a web page to access some media capture device such as a camera or microphone. %@ will be replaced with the websites address (for example: \"talk.Browser.com\")")
    static let requestCaptureDevicePermissionAllowButtonTitle = NSLocalizedString("requestCaptureDevicePermissionAllowButtonTitle", tableName: "BraveShared", bundle: .module, value: "Allow", comment: "A button shown in a permission dialog that will grant the website the ability to use the device's camera or microphone")
    static let downloadsMenuItem = NSLocalizedString("DownloadsMenuItem", tableName: "BraveShared", bundle: .module, value: "Downloads", comment: "Title for downloads menu item")
    static let downloadsPanelEmptyStateTitle = NSLocalizedString("DownloadsPanelEmptyStateTitle", tableName: "BraveShared", bundle: .module, value: "Downloaded files will show up here.", comment: "Title for when a user has nothing downloaded onto their device, and the list is empty.")

    // MARK: - Themes

    static let themesDisplayBrightness = NSLocalizedString("ThemesDisplayBrightness", tableName: "BraveShared", bundle: .module, value: "Appearance", comment: "Setting to choose the user interface theme for normal browsing mode, contains choices like 'light' or 'dark' themes")
    static let themesDisplayBrightnessFooter = NSLocalizedString("ThemesDisplayBrightnessFooter", tableName: "BraveShared", bundle: .module, value: "These settings are not applied in private browsing mode.", comment: "Text specifying that the above setting does not impact the user interface while they user is in private browsing mode.")
    static let themesAutomaticOption = NSLocalizedString("ThemesAutomaticOption", tableName: "BraveShared", bundle: .module, value: "Automatic", comment: "Selection to automatically color/style the user interface.")
    static let themesLightOption = NSLocalizedString("ThemesLightOption", tableName: "BraveShared", bundle: .module, value: "Light", comment: "Selection to color/style the user interface with a light theme.")
    static let themesDarkOption = NSLocalizedString("ThemesDarkOption", tableName: "BraveShared", bundle: .module, value: "Dark", comment: "Selection to color/style the user interface with a dark theme")
    static let themesSettings =
        NSLocalizedString(
            "themesSettings", tableName: "BraveShared", bundle: .module,
            value: "Themes",
            comment: "Name for app theme settings")
    static let defaultThemeName =
        NSLocalizedString(
            "defaultThemeName", tableName: "BraveShared", bundle: .module,
            value: "Browser default",
            comment: "Name for default Browser theme.")
    static let themeQRCodeShareTitle =
        NSLocalizedString(
            "themeQRCodeShareTitle", tableName: "BraveShared", bundle: .module,
            value: "Share Browser with your friends!",
            comment: "Title for QR popup encouraging users to share the code with their friends.")
    static let themeQRCodeShareButton =
        NSLocalizedString(
...
public extension Strings {
    static let quickActionNewTab = NSLocalizedString("ShortcutItemTitleNewTab", tableName: "BraveShared", bundle: .module, value: "New Tab", comment: "Quick Action for 3D-Touch on the Application Icon")
    static let quickActionNewPrivateTab = NSLocalizedString("ShortcutItemTitleNewPrivateTab", tableName: "BraveShared", bundle: .module, value: "New Private Tab", comment: "Quick Action for 3D-Touch on the Application Icon")
    static let quickActionScanQRCode = NSLocalizedString("ShortcutItemTitleQRCode", tableName: "BraveShared", bundle: .module, value: "Scan QR Code", comment: "Quick Action for 3D-Touch on the Application Icon")
}

// MARK: - Onboarding

public extension Strings {
    static let OBContinueButton = NSLocalizedString("OnboardingContinueButton", tableName: "BraveShared", bundle: .module, value: "Continue", comment: "Continue button to navigate to next onboarding screen.")
    static let OBSkipButton = NSLocalizedString("OnboardingSkipButton", tableName: "BraveShared", bundle: .module, value: "Skip", comment: "Skip button to skip onboarding and start using the app.")
    static let OBSaveButton = NSLocalizedString("OBSaveButton", tableName: "BraveShared", bundle: .module, value: "Save", comment: "Save button to save current selection")
    static let OBFinishButton = NSLocalizedString("OBFinishButton", tableName: "BraveShared", bundle: .module, value: "Start browsing", comment: "Button to finish onboarding and start using the app.")
    static let OBJoinButton = NSLocalizedString("OBJoinButton", tableName: "BraveShared", bundle: .module, value: "Join", comment: "Button to join Browser Rewards.")
    static let OBTurnOnButton = NSLocalizedString("OBTurnOnButton", tableName: "BraveShared", bundle: .module, value: "Start", comment: "Button to show Browser Rewards.")
    static let OBShowMeButton = NSLocalizedString("OBShowMeButton", tableName: "BraveShared", bundle: .module, value: "Show Me", comment: "Button to show the Browser Rewards Ads.")
    static let OBDidntSeeAdButton = NSLocalizedString("OBDidntSeeAdButton", tableName: "BraveShared", bundle: .module, value: "I didn't see an ad", comment: "Button to show information on how to enable ads")
    static let OBSearchEngineTitle = NSLocalizedString("OBSearchEngineTitle", tableName: "BraveShared", bundle: .module, value: "Welcome to Browser Browser", comment: "Title for search engine onboarding screen")
    static let OBSearchEngineDetail = NSLocalizedString("OBSearchEngineDetail", tableName: "BraveShared", bundle: .module, value: "Select your default search engine", comment: "Detail text for search engine onboarding screen")
    static let OBShieldsTitle = NSLocalizedString("OBShieldsTitle", tableName: "BraveShared", bundle: .module, value: "Browser Shields", comment: "Title for shields onboarding screen")
    static let OBShieldsDetail = NSLocalizedString("OBShieldsDetail", tableName: "BraveShared", bundle: .module, value: "Block privacy-invading trackers so you can browse without being followed around the web", comment: "Detail text for shields onboarding screen")
    static let OBRewardsTitle = NSLocalizedString("OBRewardsTitle", tableName: "BraveShared", bundle: .module, value: "Browser Rewards", comment: "Title for rewards onboarding screen")
    static let OBAdsOptInTitle = NSLocalizedString("OBAdsOptInTitle", tableName: "BraveShared", bundle: .module, value: "Browser Ads is here!", comment: "Title when opting into Browser Ads when region becomes available")
    static let OBAdsOptInMessage = NSLocalizedString("OBAdsOptInMessage", tableName: "BraveShared", bundle: .module, value: "Earn tokens and reward creators for great content while you browse.", comment: "Message when opting into Browser Ads when region becomes available")
    static let OBAdsOptInMessageJapan = NSLocalizedString("OBAdsOptInMessageJapan", tableName: "BraveShared", bundle: .module, value: "Earn points and reward creators for great content while you browse.", comment: "Message when opting into Browser Ads when region becomes available")
    static let OBRewardsDetailInAdRegion = NSLocalizedString("OBRewardsDetailInAdRegion", tableName: "BraveShared", bundle: .module, value: "Earn tokens and reward creators for great content while you browse.", comment: "Detail text for rewards onboarding screen")
    static let OBRewardsDetail = NSLocalizedString("OBRewardsDetail", tableName: "BraveShared", bundle: .module, value: "Opting into Browser Private Ads supports publishers and content creators with every ad viewed.", comment: "Detail text for rewards onboarding screen")
    static let OBRewardsAgreementTitle = NSLocalizedString("OBRewardsAgreementTitle", tableName: "BraveShared", bundle: .module, value: "Browser Rewards", comment: "Title for rewards agreement onboarding screen")
    static let OBRewardsAgreementDetail = NSLocalizedString("OBRewardsAgreementDetail", tableName: "BraveShared", bundle: .module, value: "By tapping Yes, you agree to the", comment: "Detail text for rewards agreement onboarding screen")
    static let OBRewardsAgreementDetailLink = NSLocalizedString("OBRewardsAgreementDetailLink", tableName: "BraveShared", bundle: .module, value: "Terms of Service", comment: "Detail text for rewards agreement onboarding screen")
    static let OBRewardsPrivacyPolicyDetailLink = NSLocalizedString("OBRewardsPrivacyPolicyDetailLink", tableName: "BraveShared", bundle: .module, value: "Privacy Policy", comment: "Detail text for rewards agreement onboarding screen")
    static let OBRewardsAgreementDetailsAnd = NSLocalizedString("OBRewardsAgreementDetailsAnd", tableName: "BraveShared", bundle: .module, value: "and", comment: "Detail text for rewards agreement onboarding screen")
    static let OBAdsTitle = NSLocalizedString("OBAdsTitle", tableName: "BraveShared", bundle: .module, value: "Browser will show your first ad in", comment: "Title for ads onboarding screen")
    static let OBCompleteTitle = NSLocalizedString("OBCompleteTitle", tableName: "BraveShared", bundle: .module, value: "Now you're ready to go.", comment: "Title for when the user completes onboarding")
    static let OBErrorTitle = NSLocalizedString("OBErrorTitle", tableName: "BraveShared", bundle: .module, value: "Sorry", comment: "A generic error title for onboarding")
    static let OBErrorDetails = NSLocalizedString("OBErrorDetails", tableName: "BraveShared", bundle: .module, value: "Something went wrong while creating your wallet. Please try again", comment: "A generic error body for onboarding")
    static let OBErrorOkay = NSLocalizedString("OBErrorOkay", tableName: "BraveShared", bundle: .module, value: "Okay", comment: "")
    static let OBPrivacyConsentTitle = NSLocalizedString("OBPrivacyConsentTitle", tableName: "BraveShared", bundle: .module, value: "Anonymous referral code check", comment: "")
    static let OBPrivacyConsentDetail = NSLocalizedString("OBPrivacyConsentDetail", tableName: "BraveShared", bundle: .module, value: "You may have downloaded Browser in support of your referrer. To detect your referrer, Browser performs a one-time check of your clipboard for the matching referral code. This check is limited to the code only and no other personal data will be transmitted.  If you opt out, your referrer won’t receive rewards from Browser.", comment: "")
    static let OBPrivacyConsentClipboardPermission = NSLocalizedString("OBPrivacyConsentClipboardPermission", tableName: "BraveShared", bundle: .module, value: "Allow Browser to check my clipboard for a matching referral code", comment: "")
    static let OBPrivacyConsentYesButton = NSLocalizedString("OBPrivacyConsentYesButton", tableName: "BraveShared", bundle: .module, value: "Allow one-time clipboard check", comment: "")
    static let OBPrivacyConsentNoButton = NSLocalizedString("OBPrivacyConsentNoButton", tableName: "BraveShared", bundle: .module, value: "Do not allow this check", comment: "")
}

// MARK: - Ads Notifications

public extension Strings {
    static let monthlyAdsClaimNotificationTitle = NSLocalizedString("MonthlyAdsClaimNotificationTitle", tableName: "BraveShared", bundle: .module, value: "Browser Rewards 💵🎁", comment: "The title of the notification that goes out monthly to users who can claim an ads grant")
    static let monthlyAdsClaimNotificationBody = NSLocalizedString("MonthlyAdsClaimNotificationBody", tableName: "BraveShared", bundle: .module, value: "Tap to claim your free tokens.", comment: "The body of the notification that goes out monthly to users who can claim an ads grant")
}

// MARK: - Bookmark restoration

public extension Strings {
    static let restoredBookmarksFolderName = NSLocalizedString("RestoredBookmarksFolderName", tableName: "BraveShared", bundle: .module, value: "Restored Bookmarks", comment: "Name of folder where restored bookmarks are retrieved")
    static let restoredFavoritesFolderName = NSLocalizedString("RestoredFavoritesFolderName", tableName: "BraveShared", bundle: .module, value: "Restored Favorites", comment: "Name of folder where restored favorites are retrieved")
}

// MARK: - User Wallet

public extension Strings {
    static let userWalletCloseButtonTitle = NSLocalizedString("UserWalletCloseButtonTitle", tableName: "BraveShared", bundle: .module, value: "Close", comment: "")
    static let userWalletGenericErrorTitle = NSLocalizedString("UserWalletGenericErrorTitle", tableName: "BraveShared", bundle: .module, value: "Sorry, something went wrong", comment: "")
    static let userWalletGenericErrorMessage = NSLocalizedString("UserWalletGenericErrorMessage", tableName: "BraveShared", bundle: .module, value: "There was a problem logging into your Uphold account. Please try again", comment: "")
}
    ...
    enum NTP {
        ...
        public static let earningsReport =
            NSLocalizedString(
                ...
                tableName: "BraveShared",
                bundle: .module,
                value: "You earned %@ by browsing with Browser.",
                comment: "Placeholder example: 'You earned 42 BAT by browsing with Browser.'")
        ...
        public static let learnMoreAboutRewards =
            NSLocalizedString(
                ...
                tableName: "BraveShared",
                bundle: .module,
                value: "Learn more about Browser Rewards",
                comment: "")
        ...
        public static let braveSupportFavoriteTitle =
            NSLocalizedString(
                ...
                comment: "Bookmark title for Browser Support")
        ...
        public static let imageTypeSelectionDescription =
            NSLocalizedString(
                ...
                tableName: "BraveShared",
                bundle: .module,
                value: "'Sponsored' are additional branded backgrounds you can earn from with Browser Rewards enabled.",
...
public extension Strings {
    enum Popover {
        public static let closeShieldsMenu = NSLocalizedString("PopoverShieldsMenuClose", tableName: "BraveShared", bundle: .module, value: "Close Shields Menu", comment: "Description for closing the `Browser Shields` popover menu that is displayed.")
    }
}
...
public extension Strings {
    enum Shields {
        public static let toggleHint = NSLocalizedString("BraveShieldsToggleHint", tableName: "BraveShared", bundle: .module, value: "Double-tap to toggle Browser Shields", comment: "The accessibility hint spoken when focused on the main shields toggle")
        public static let statusTitle = NSLocalizedString("BraveShieldsStatusTitle", tableName: "BraveShared", bundle: .module, value: "Browser Shields", comment: "Context: 'Browser Shields Up' or 'Browser Shields Down'")
        public static let statusValueUp = NSLocalizedString("BraveShieldsStatusValueUp", tableName: "BraveShared", bundle: .module, value: "Up", comment: "Context: The 'Up' in 'Browser Shields Up'")
        public static let statusValueDown = NSLocalizedString("BraveShieldsStatusValueDown", tableName: "BraveShared", bundle: .module, value: "Down", comment: "Context: The 'Down' in 'Browser Shields Down'")
        ...
        public static let aboutBraveShieldsTitle = NSLocalizedString("AboutBraveShields", tableName: "BraveShared", bundle: .module, value: "About Browser Shields", comment: "The title of the screen explaining Browser Shields")
        public static let aboutBraveShieldsBody = NSLocalizedString("AboutBraveShieldsBody", tableName: "BraveShared", bundle: .module, value: "Sites often include cookies and scripts which try to identify you and your device. They want to work out who you are and follow you across the web — tracking what you do on every site.\n\nBrowser blocks these things so that you can browse without being followed around.", comment: "The body of the screen explaining Browser Shields")
        public static let shieldsDownDisclaimer = NSLocalizedString("ShieldsDownDisclaimer", tableName: "BraveShared", bundle: .module, value: "You're browsing this site without Browser's privacy protections. Does it not work right with Shields up?", comment: "")
        ...
        public static let siteReportedBody = NSLocalizedString("SiteReportedBody", tableName: "BraveShared", bundle: .module, value: "Thanks for letting Browser's developers know that there's something wrong with this site. We'll do our best to fix it!", comment: "")
    ...
    enum ShieldEducation {
        ...
        public static let trackerAdWarningSubtitle =
            NSLocalizedString("shieldEducation.trackerAdWarningSubTitle", tableName: "BraveShared", bundle: .module,
                              value: "Browser Shields just protected your online privacy.",
        ...
        public static let shareDescriptionTitle =
            NSLocalizedString("socialSharing.shareDescriptionTitle", tableName: "BraveShared", bundle: .module,
                              value: "Every day I save data by browsing the web with Browser.",
                              comment: "Text used for social sharing together with Browser Shield values")
    ...
    enum PlayList {
        ...
        public static let noItemLabelDetailLabel =
            NSLocalizedString("playList.noItemLabelDetailLabel", tableName: "BraveShared", bundle: .module,
                              value: "You can add items to your Browser Playlist within the browser",
        ...
        public static let toastExitingItemPlaylistTitle =
            NSLocalizedString("playList.toastExitingItemPlaylistTitle", tableName: "BraveShared", bundle: .module,
                              value: "View in Browser Playlist",
        ...
        public static let menuBadgeOptionFooterText =
            NSLocalizedString("playlist.menuBadgeOptionFooterText", tableName: "BraveShared", bundle: .module,
                              value: "When enabled, a badge will be displayed on the main menu icon, indicating media on the page may be added to Browser Playlist.",
    ...
    enum PlaylistFolders {
        ...
        public static let playlistFolderMoveItemDescription =
            NSLocalizedString("playlistFolders.moveItemDescription", tableName: "BraveShared", bundle: .module,
                              ...
                              comment: "%@ Should NOT be localized. It is a placeholder. Example: Browser Folder and 1 more item.")
        ...
        public static let playlistFolderMoveMultipleItemDescription =
            NSLocalizedString("playlistFolders.moveMultipleItemDescription", tableName: "BraveShared", bundle: .module,
                              ...
                              comment: "%@ and %lld Should NOT be localized. They are placeholders. Example: Browser Folder and 3 more items. Music and 2 more items.")
    ...
    enum PlaylistFolderSharing {
        ...
        public static let playlistSharedFolderAlreadyExistsBody =
            NSLocalizedString("playList.playlistSharedFolderAlreadyExistsBody", tableName: "BraveShared", bundle: .module,
                              value: "This folder already exists in your Playlist",
    ...
    enum CertificateViewer {
        ...
        public static let organizationTitle =
            NSLocalizedString("certificateViewer.organizationTitle", tableName: "BraveShared", bundle: .module,
                              value: "Organization",
                              comment: "Title of the section for Name of the Company. Example: Browser Inc.")
        ...
        public static let domainComponentTitle =
            NSLocalizedString("certificateViewer.domainComponentTitle", tableName: "BraveShared", bundle: .module,
                              ...
                              comment: "Title of the section for the Domain Component such as: DNS or Browser.com or a website's domain.")
    ...
    enum Shortcuts {
        ...
        public static let activityTypeOpenBookmarksTitle =
            NSLocalizedString("shortcuts.activityTypeOpenBookmarksTitle", tableName: "BraveShared", bundle: .module,
                              value: "Open Browser Browser Bookmarks",
                              comment: "")
        ...
        public static let activityTypeOpenHistoryListTitle =
            NSLocalizedString("shortcuts.activityTypeOpenHistoryListTitle", tableName: "BraveShared", bundle: .module,
                              value: "Open Browser Browser History",
                              comment: "")
        ...
        public static let activityTypeClearHistoryTitle =
            NSLocalizedString("shortcuts.activityTypeClearHistoryTitle", tableName: "BraveShared", bundle: .module,
                              value: "Clear Browser Browsing History",
                              comment: "")
        ...
        public static let activityTypeEnableVPNTitle =
            NSLocalizedString("shortcuts.activityTypeEnableVPNTitle", tableName: "BraveShared", bundle: .module,
                              value: "Open Browser Browser and Enable VPN",
                              comment: "")
        ...
        public static let activityTypeTabDescription =
            NSLocalizedString("shortcuts.activityTypeTabDescription", tableName: "BraveShared", bundle: .module,
                              value: "Start Searching the Web Securely with Browser",
                              comment: "")
        ...
        public static let activityTypeBraveNewsDescription =
            NSLocalizedString("shortcuts.activityTypeBraveNewsDescription", tableName: "BraveShared", bundle: .module,
                              value: "Open Browser News and Check Today's Top Stories",
                              comment: "")
        ...
        public static let activityTypeOpenSyncedTabsDescription =
            NSLocalizedString("shortcuts.activityTypeOpenSyncedTabsDescription", tableName: "BraveShared", bundle: .module,
                              value: "Open Browser Tabs Open in Other Devices",
                              comment: "")
        ...
        public static let shortcutSettingsEnableVPNDescription =
            NSLocalizedString("shortcuts.shortcutSettingsEnableVPNDescription", tableName: "BraveShared", bundle: .module,
                              value: "Use Shortcuts to enable Browser VPN via Siri - Voice Assistant",
                              comment: "")
        ...
        public static let shortcutSettingsOpenBraveNewsDescription =
            NSLocalizedString("shortcuts.shortcutSettingsOpenBraveNewsDescription", tableName: "BraveShared", bundle: .module,
                              value: "Use Shortcuts to open a new tab & show Browser News Feed via Siri - Voice Assistant",
                              comment: "Description of Open Browser News Siri Shortcut in Settings Screen")
        ...
        public static let shortcutOpenApplicationSettingsDescription =
            NSLocalizedString("shortcuts.shortcutOpenApplicationSettingsDescription", tableName: "BraveShared", bundle: .module,
                              value: "This option will open Browser Settings. In order to change various Siri options, please select 'Siri & Search' menu item and customize your choices.",
                              comment: "Description for opening Browser Settings for altering Siri shortcut.")
    }
}
    ...
    enum VPN {
        ...
        public static let checkboxProtectYourDevices =
            NSLocalizedString("vpn.checkboxProtectYourDevices", tableName: "BraveShared", bundle: .module,
                              ...
                              comment: "Text for a checkbox to present the user benefits for using Browser VPN")
        ...
        public static let checkboxNoIPLog =
            NSLocalizedString("vpn.checkboxNoIPLog", tableName: "BraveShared", bundle: .module,
                              value: "Browser never logs your activity",
                              comment: "Text for a checkbox to present the user benefits for using Browser VPN")
        ...
        public static let installProfileTitle =
            NSLocalizedString("vpn.installProfileTitle", tableName: "BraveShared", bundle: .module,
                              value: "Browser will now install a VPN profile.",
                              comment: "")
        ...
        public static let installProfileBody =
            NSLocalizedString("vpn.installProfileBody", tableName: "BraveShared", bundle: .module,
                              value: "This profile allows the VPN to automatically connect and secure traffic across your device all the time. This VPN connection will be encrypted and routed through Browser's intelligent firewall to block potentially harmful and invasive connections.",
        ...
        public static let settingsLinkReceipt =
            NSLocalizedString("vpn.settingsLinkReceipt", tableName: "BraveShared", bundle: .module,
                              value: "Link purchase to your Browser account",
        ...
        public static let settingsLinkReceiptFooter =
            NSLocalizedString("vpn.settingsLinkReceiptFooter", tableName: "BraveShared", bundle: .module,
                              value: "Link your App Store purchase to your Browser account to use Browser VPN on other devices.",
        ...
        public static let vpnConfigPermissionDeniedErrorBody =
            NSLocalizedString("vpn.vpnConfigPermissionDeniedErrorBody", tableName: "BraveShared", bundle: .module,
                              value: "The Browser Firewall + VPN requires a VPN profile to be installed on your device to work. ",
                              comment: "Title for an alert when the user didn't allow to install VPN profile")
        ...
        public static let vpnResetAlertBody =
            NSLocalizedString("vpn.vpnResetAlertBody", tableName: "BraveShared", bundle: .module,
                              value: "This will reset your Browser Firewall + VPN configuration and fix any errors. This process may take a minute.",
        ...
        public static let contactFormDoNotEditText =
            NSLocalizedString("vpn.contactFormDoNotEditText", tableName: "BraveShared", bundle: .module,
                              value: "Browser doesn’t track you or know how you use our app, so we don’t know how you've set up VPN. Please share info about the issue you're experiencing and we'll do our best to resolve it as soon as we can.",
        ...
        public static let contactFormTitle =
            NSLocalizedString("vpn.contactFormTitle", tableName: "BraveShared", bundle: .module,
                              value: "Browser Firewall + VPN Issue",
        ...
        public static let vpnBackgroundNotificationTitle =
            NSLocalizedString("vpn.vpnBackgroundNotificationTitle", tableName: "BraveShared", bundle: .module,
                              value: "Browser Firewall + VPN is ON",
        ...
        public static let sessionExpiredDescription =
            NSLocalizedString("vpn.sessionExpiredDescription", tableName: "BraveShared", bundle: .module,
                              value: "Please login to your Browser Account to refresh your VPN session.",
        ...
        public static let autoRenewSoonExpirePopOverTitle =
            NSLocalizedString("vpn.autoRenewSoonExpireTitle", tableName: "BraveShared", bundle: .module,
                              value: "Oh no! Your Browser VPN subscription is about to expire.",
        ...
        public static let autoRenewDiscountPopOverTitle =
            NSLocalizedString("vpn.autoRenewDiscountPopOverTitle", tableName: "BraveShared", bundle: .module,
                              value: "Auto-renew your Browser VPN Subscription now and get 20% off for 3 months!",
        ...
        public static let autoRenewFreeMonthPopOverTitle =
            NSLocalizedString("vpn.autoRenewFreeMonthPopOverTitle", tableName: "BraveShared", bundle: .module,
                              value: "Auto-renew your Browser VPN Subscription now and get 1 month free!",
        ...
        public static let updateBillingSoonExpirePopOverTitle =
            NSLocalizedString("vpn.updateBillingSoonExpirePopOverTitle", tableName: "BraveShared", bundle: .module,
                              value: "There's a billing issue with your account, which means your Browser VPN subscription is about to expire.",
        ...
        public static let updateBillingExpiredPopOverTitle =
            NSLocalizedString("vpn.updateBillingExpiredPopOverTitle", tableName: "BraveShared", bundle: .module,
                              value: "Update your payment info to stay protected with Browser VPN.",
        ...
        public static let autoRenewSoonExpirePopOverDescription =
            NSLocalizedString("vpn.autoRenewSoonExpirePopOverDescription", tableName: "BraveShared", bundle: .module,
                              value: "That means you'll lose Browser's extra protections for every app on your phone.",
        ...
        public static let subscribeVPNDiscountPopOverTitle =
            NSLocalizedString("vpn.subscribeVPNDiscountPopOverTitle", tableName: "BraveShared", bundle: .module,
                              value: "Give Browser VPN another try and get 20% off for 3 months!",
        ...
        public static let subscribeVPNProtectionPopOverTitle =
            NSLocalizedString("vpn.subscribeVPNProtectionPopOverTitle", tableName: "BraveShared", bundle: .module,
                              value: "Did you know that Browser VPN protects you outside of Browser Browser?",
                              comment: "Pop up title for subscribing VPN explaning VPN protects user outside the Browser")
        ...
        public static let subscribeVPNAllDevicesPopOverTitle =
            NSLocalizedString("vpn.subscribeVPNAllDevicesPopOverTitle", tableName: "BraveShared", bundle: .module,
                              value: "Now, use Browser VPN on all your devices for the same price!",
        ...
        public static let subscribeVPNProtectionPopOverDescription =
            NSLocalizedString("vpn.subscribeVPNProtectionPopOverDescription", tableName: "BraveShared", bundle: .module,
                              value: "Browser VPN has always blocked trackers on every app, even outside the Browser browser. Now you can see who tried to track you, with the Browser Privacy Hub.",
                              comment: "Pop up description for subscribing VPN explaning VPN protects user outside the Browser")
        ...
        public static let subscribeVPNAllDevicesPopOverDescription =
            NSLocalizedString("vpn.subscribeVPNAllDevicesPopOverDescription", tableName: "BraveShared", bundle: .module,
                              value: "That’s right. Your Browser VPN subscription is now good on up to 5 devices. So you can subscribe on iOS and use it on your Mac, Windows and Android devices for free.",
        ...
        public static let subscribeVPNPopOverSubDescription =
            NSLocalizedString("vpn.subscribeVPNPopOverSubDescription", tableName: "BraveShared", bundle: .module,
                              value: "Ready to safeguard every app on your phone? Come back to Browser VPN and get 20% off for the next 3 months.",
    ...
    enum Sync {
        ...
        public static let syncDeleteAccountAlertDescriptionPart1 =
            NSLocalizedString(
                ...
                value: "Deleting your account will remove your encrypted data from Browser servers and disable Sync on all of your connected devices. It will not however delete the data that is stored locally on those devices.",
    ...
    enum Privacy {
        ...
        public static let browserLockDescription =
            NSLocalizedString(
                ...
                value: "Unlock Browser with Touch ID, Face ID or system passcode.",
    ...
    enum OpenTabs {
        ...
        public static let noSyncSessionPlaceHolderViewTitle =
            NSLocalizedString(
                ...
                tableName: "BraveShared",
                bundle: .module,
                value: "This space shows Browser tabs open in other devices",
        ...
        public static let noSyncSessionPlaceHolderViewAdditionalDescription =
            NSLocalizedString(
                ...
                tableName: "BraveShared",
                bundle: .module,
                value: "Manage what Browser syncs in Settings.",
...
public extension Strings {
    enum BraveNews {
        ...
        public static let introCardTitle = NSLocalizedString("today.introCardTitle", tableName: "BraveShared", bundle: .module,
                                                             value: "Turn on Browser News, and never miss a story",
                                                             comment: "Shown above a button that turns on the \"Browser News\" product in the app.")
        public static let introCardBody = NSLocalizedString("today.introCardBody", tableName: "BraveShared", bundle: .module,
                                                            value: "Follow your favorite sources, in a single feed. Just open a tab in Browser, scroll down, and… voila!\nBrowser News is ad-supported with private, anonymized ads.",
                                                            comment: "Shown above a button that turns on the \"Browser News\" product in the app. by sources & feeds they mean websites & blogs.")
        ...
        public static let errorGeneralBody = NSLocalizedString("today.errorGeneralBody", tableName: "BraveShared", bundle: .module,
                                                               value: "Browser News is experiencing some issues. Try again.",
                                                               comment: "")
        public static let disablePublisherContent = NSLocalizedString("today.disablePublisherContent", tableName: "BraveShared", bundle: .module,
                                                                      ...
                                                                      comment: "'%@' will turn into the name of a publisher (verbatim), for example: Browser Blog")
        ...
        public static let moreBraveOffers = NSLocalizedString("today.moreBraveOffers", tableName: "BraveShared", bundle: .module,
                                                              value: "More Browser Offers",
                                                              comment: "'Browser Offers' is a product name")
        ...
        public static let addSourceShareTitle = NSLocalizedString("today.addSourceShareTitle", tableName: "BraveShared", bundle: .module,
                                                                  value: "Add Source to Browser News",
        ...
        public static let getFeedsFromSiteButtonTitle = NSLocalizedString(
            ...
            comment: "Shown with a website the user has typed in after the text. For example: 'Get feeds from https://Browser.com'.")
        ...
        public static let rateBraveCardRateActionTitle = NSLocalizedString(
            "today.rateBrowserCardRateActionTitle",
            tableName: "BraveShared",
            bundle: .module,
            value: "Rate Browser",
...
public extension Strings {
    enum RewardsInternals {
        public static let title = NSLocalizedString("RewardsInternalsTitle", tableName: "BraveShared", bundle: .module, value: "Rewards Internals", comment: "'Rewards' as in 'Browser Rewards'")
        ...
        public static let contributionProcessorBraveTokens = NSLocalizedString("RewardsInternalsContributionProcessorBraveTokens", tableName: "BraveShared", bundle: .module, value: "Browser Tokens", comment: "")
        ...
        public static let shareInternalsTitle = NSLocalizedString("RewardsInternalsShareInternalsTitle", tableName: "BraveShared", bundle: .module, value: "Share Rewards Internals", comment: "'Rewards' as in 'Browser Rewards'")
...
public extension Strings {
    enum Rewards {
        public static let enabledBody = NSLocalizedString("rewards.enabledBody", tableName: "BraveShared", bundle: .module,
                                                          ...
                                                          comment: "Displayed when Browser Rewards is enabled")
        public static let disabledBody = NSLocalizedString("rewards.disabledBody", tableName: "BraveShared", bundle: .module,
                                                           ...
                                                           comment: "Displayed when Browser Rewards is disabled")
        ...
        public static let disabledStatusBody = NSLocalizedString("rewards.disabledStatusBody", tableName: "BraveShared", bundle: .module,
                                                                 value: "Using Browser Rewards helps support content creators as you browse.",
        ...
        public static let settingsToggleMessage = NSLocalizedString("rewards.settingsToggleMessage", tableName: "BraveShared", bundle: .module,
                                                                    value: "Support content creators and publishers automatically by enabling Browser Private Ads. Browser Private Ads are privacy-respecting ads that give back to content creators.",
                                                                    comment: "")
        ...
        public static let braveTalkRewardsOptInTitle =
            NSLocalizedString(
                ...
                tableName: "BraveShared",
                bundle: .module,
                value: "To start a free call, turn on Browser Rewards",
                comment: "Title for Browser Talk rewards opt-in screen")
        ...
        public static let braveTalkRewardsOptInBody =
            NSLocalizedString(
                ...
                tableName: "BraveShared",
                bundle: .module,
                value: "With Browser Rewards, you can view privacy-preserving ads from the Browser Ads network. No trackers. No slowdowns. And your data stays totally safe.",
                comment: "Body for Browser Talk rewards opt-in screen")
        ...
        public static let braveTalkRewardsOptInButtonTitle =
            NSLocalizedString(
                ...
                comment: "Title for Browser Talk rewards opt-in screen button")
        ...
        public static let braveTalkRewardsOptInSuccessTitle =
            NSLocalizedString(
                ...
                comment: "Title for successful Browser Talk rewards opt-in")
        ...
        public static let braveTalkRewardsOptInSuccessBody =
            NSLocalizedString(
                ...
                tableName: "BraveShared",
                bundle: .module,
                value: "Click anywhere on the screen to continue to Browser Talk.",
                comment: "Body for successful Browser Talk rewards opt-in")
    }
}
...
public extension Strings {
    enum Ads {
        public static let myFirstAdTitle = NSLocalizedString("MyFirstAdTitle", tableName: "BraveShared", bundle: .module, value: "This is your first Browser ad", comment: "")
        ...
        public static let adNotificationTitle = NSLocalizedString("BraveRewardsAdNotificationTitle", tableName: "BraveShared", bundle: .module, value: "Browser Rewards", comment: "")
    }
}
...
public extension Strings {
    static let recentSearchFavorites = NSLocalizedString("RecentSearchFavorites", tableName: "BraveShared", bundle: .module, value: "Favorites", comment: "Recent Search Favorites Section Title")
    static let recentSearchPasteAndGo = NSLocalizedString("RecentSearchPasteAndGo", tableName: "BraveShared", bundle: .module, value: "Paste & Go", comment: "Recent Search Paste & Go Button Title")
    static let recentSearchSectionTitle = NSLocalizedString("RecentSearchSectionTitle", tableName: "BraveShared", bundle: .module, value: "Recent Searches", comment: "Recent Search Section Title")
    static let recentSearchSectionDescription = NSLocalizedString("RecentSearchSectionDescription", tableName: "BraveShared", bundle: .module, value: "Recent Searches allow you to privately access past searches. Would you like to enable Recent Searches?", comment: "Recent Search Section Description")
    static let recentSearchClear = NSLocalizedString("RecentSearchClear", tableName: "BraveShared", bundle: .module, value: "Clear", comment: "Recent Search Clear Button")
    static let recentSearchShow = NSLocalizedString("RecentSearchShow", tableName: "BraveShared", bundle: .module, value: "Show", comment: "Recent Search Show Button")
    static let recentSearchHide = NSLocalizedString("RecentSearchHide", tableName: "BraveShared", bundle: .module, value: "Hide", comment: "Recent Search Hide Button")
    static let recentShowMore = NSLocalizedString("RecentSearchShowMore", tableName: "BraveShared", bundle: .module, value: "Show more", comment: "Recent Search Show More button")
    static let recentSearchScanned = NSLocalizedString("RecentSearchScanned", tableName: "BraveShared", bundle: .module, value: "Scanned", comment: "Recent Search Scanned text when a user scans a qr code")
    static let recentSearchQuickSearchOnWebsite = NSLocalizedString("RecentSearchQuickSearchOnWebsite", tableName: "BraveShared", bundle: .module, value: "on", comment: "Recent Search 'on' text when a user searches 'on' a website")
    static let recentSearchSuggestionsTitle = NSLocalizedString("RecentSearchSuggestionsTitle", tableName: "BraveShared", bundle: .module, value: "Search Suggestions", comment: "Recent Search suggestions title when prompting to turn on suggestions")
    static let recentSearchEnableSuggestions = NSLocalizedString("RecentSearchEnableSuggestions", tableName: "BraveShared", bundle: .module, value: "Enable", comment: "Recent Search button title to enable suggestions")
    static let recentSearchDisableSuggestions = NSLocalizedString("RecentSearchDisableSuggestions", tableName: "BraveShared", bundle: .module, value: "Disable", comment: "Recent Search button title to disable suggestions")
    static let recentSearchClearDataToggleOption = NSLocalizedString("RecentSearchClearDataToggleOption", tableName: "BraveShared", bundle: .module, value: "Recent Search Data", comment: "Recent Search setting title to clear recent searches")
    static let recentSearchScannerTitle = NSLocalizedString("RecentSearchScannerTitle", tableName: "BraveShared", bundle: .module, value: "Scan QR Code", comment: "Scanning a QR Code for searching")
    static let recentSearchScannerDescriptionTitle = NSLocalizedString("RecentSearchScannerDescriptionTitle", tableName: "BraveShared", bundle: .module, value: "Instructions", comment: "Scanning a QR Code for title")
    static let recentSearchScannerDescriptionBody = NSLocalizedString("RecentSearchScannerDescriptionBody", tableName: "BraveShared", bundle: .module, value: "To search by QR Code, align the QR Code in the center of the frame.", comment: "Scanning a QR Code for searching body")
    static let recentSearchClearAlertButton = NSLocalizedString("RecentSearchClearAlertButton", tableName: "BraveShared", bundle: .module, value: "Clear Recent", comment: "The button title that shows when you clear all recent searches")
}
...
public extension Strings {
    static let manageWebsiteDataTitle = NSLocalizedString("websiteData.manageWebsiteDataTitle", tableName: "BraveShared", bundle: .module,
    ...
    static let loadingWebsiteData = NSLocalizedString("websiteData.loadingWebsiteData", tableName: "BraveShared", bundle: .module,
                                                      value: "Loading website data…",
                                                      comment: "A message displayed to users while the system fetches all website data to display.")
    static let dataRecordCookies = NSLocalizedString("websiteData.dataRecordCookies", tableName: "BraveShared", bundle: .module,
                                                     value: "Cookies",
                                                     comment: "The word used to describe small bits of state stored locally in a web browser (e.g. Browser cookies)")
    static let dataRecordCache = NSLocalizedString("websiteData.dataRecordCache", tableName: "BraveShared", bundle: .module,
                                                   value: "Cache",
                                                   comment: "Temporary data that is stored on the users device to speed up future requests and interactions.")
    static let dataRecordLocalStorage = NSLocalizedString("websiteData.dataRecordLocalStorage", tableName: "BraveShared", bundle: .module,
                                                          value: "Local storage",
    ...
    static let dataRecordDatabases = NSLocalizedString("websiteData.dataRecordDatabases", tableName: "BraveShared", bundle: .module,
                                                       value: "Databases",
                                                       comment: "Some data stored on disk that is a kind of database (such as WebSQL or IndexedDB.)")
    static let removeDataRecord = NSLocalizedString("websiteData.removeDataRecord", tableName: "BraveShared", bundle: .module,
                                                    value: "Remove",
    ...
    static let removeSelectedDataRecord = NSLocalizedString("websiteData.removeSelectedDataRecord", tableName: "BraveShared", bundle: .module,
    ...
    static let removeAllDataRecords = NSLocalizedString("websiteData.removeAllDataRecords", tableName: "BraveShared", bundle: .module,
                                                        value: "Remove All",
    ...
    static let noSavedWebsiteData = NSLocalizedString("websiteData.noSavedWebsiteData", tableName: "BraveShared", bundle: .module,
    ...
    static let blockCookieConsentNotices = NSLocalizedString(
...
public extension Strings {
    enum PrivacyHub {
        public static let privacyReportsTitle = NSLocalizedString("privacyHub.privacyReportsTitle", tableName: "BraveShared", bundle: .module,
                                                                  value: "Privacy Hub",
                                                                  comment: "Title of main privacy hub screen. This screen shows various stats caught by Browser's ad blockers.")
        ...
        public static let mostFrequentTrackerAndAdBody = NSLocalizedString("privacyHub.mostFrequentTrackerAndAdBody", tableName: "BraveShared", bundle: .module,
                                                                           ...
                                                                           comment: "Do NOT localize asterisk('*') characters, they are used to make the text bold in the app. It says which tracker was blocked on how many websites, example usage: 'Google Analytics was blocked by Browser Shields on 42 sites'")
        ...
        public static let vpnAlertsHeader = NSLocalizedString("privacyHub.vpnAlertsHeader", tableName: "BraveShared", bundle: .module,
                                                              value: "Browser Firewall + VPN Alerts",
        ...
        public static let allVPNAlertsButtonText = NSLocalizedString("privacyHub.allVPNAlertsButtonText", tableName: "BraveShared", bundle: .module,
                                                                     value: "All alerts",
                                                                     comment: "Text for a button to display a list of all alerts caught by the Browser VPN. VPN alert is a notificaion of what item has been blocked by the vpn, similar to a regular adblocker")
        ...
        public static let allTimeListsTrackersView = NSLocalizedString("privacyHub.allTimeListsTrackersView", tableName: "BraveShared", bundle: .module,
                                                                       value: "Trackers & ads",
                                                                       comment: "Title of a section to show total count of trackers blocked by Browser")
        ...
        public static let blockedBy = NSLocalizedString("privacyHub.blockedBy", tableName: "BraveShared", bundle: .module,
                                                        value: "Blocked by",
                                                        comment: "Text which explain by what type of ad blocker a given resource was blocked. Context is like: 'Blocked by Browser Shields', 'Blocked by BrowserVPN")
        ...
        public static let vpnLabel = NSLocalizedString("privacyHub.vpnLabel", tableName: "BraveShared", bundle: .module,
                                                       value: "Firewall + VPN",
                                                       comment: "This label says about Browser VPN, as a source of by what the resource was blocked by. Think of it in context of 'Blocked by VPN'")
        ...
        public static let notificationMessage = NSLocalizedString("privacyHub.notificationMessage", tableName: "BraveShared", bundle: .module,
                                                                  value: "A recap of how Browser protected you online this week.",
        ...
        public static let settingsEnableShieldsTitle = NSLocalizedString("privacyHub.settingsEnableShieldsTitle", tableName: "BraveShared", bundle: .module,
                                                                         ...
                                                                         comment: "Title of a setting that lets Browser monitor blocked network requests")
        ...
        public static let settingsEnableShieldsFooter = NSLocalizedString("privacyHub.settingsEnableShieldsFooter", tableName: "BraveShared", bundle: .module,
                                                                          ...
                                                                          comment: "This text explains a setting that lets Browser monitor blocked network requests")
        ...
        public static let settingsEnableVPNAlertsTitle = NSLocalizedString("privacyHub.settingsEnableVPNAlertsTitle", tableName: "BraveShared", bundle: .module,
                                                                           ...
                                                                           comment: "Title of a setting that lets Browser monitor blocked network requests captured by Browser VPN")
        ...
        public static let settingsEnableVPNAlertsFooter = NSLocalizedString("privacyHub.settingsEnableVPNAlertsFooter", tableName: "BraveShared", bundle: .module,
                                                                            ...
                                                                            comment: "This text explains a setting that lets Browser monitor blocked network requests captured by Browser VPN")
        ...
        public static let settingsSlearDataTitle = NSLocalizedString("privacyHub.settingsSlearDataTitle", tableName: "BraveShared", bundle: .module,
                                                                     ...
                                                                     comment: "Button that lets user clear all blocked requests and vpn alerts data that Browser captured for them.")
...
public extension Strings {
    enum P3A {
        public static let settingTitle = NSLocalizedString(
            ...
            comment: "The title for the setting that will allow a user to toggle sending privacy preserving analytics to Browser.")

        public static let settingSubtitle = NSLocalizedString(
            "p3a.settingSubtitle", tableName: "BraveShared", bundle: .module,
            value: "Anonymised P3A info helps Browser estimate overall usage and ensure we're improving popular features.",
            comment: "A subtitle shown on the setting that toggles analytics on Browser.")
    ...
    enum VoiceSearch {
        ...
        public static let screenDisclaimer =
            NSLocalizedString(
                ...
                tableName: "BraveShared",
                bundle: .module,
                value: "Browser does not store or share your voice searches.",
        ...
        public static let microphoneAccessRequiredWarningDescription =
            NSLocalizedString(
                ...
                tableName: "BraveShared",
                bundle: .module,
                value: "Please allow Microphone Access in iOS System Settings for Browser to use anonymous voice search.",
...
public extension Strings {
    // Errors
    static let unsupportedInstrumentMessage = NSLocalizedString("unsupportedInstrumentMessage", tableName: "BraveShared", bundle: .module, value: "Unsupported payment instruments", comment: "Error message if list of Payment Instruments doesn't include BAT")
    static let userCancelledMessage = NSLocalizedString("userCancelledMessage", tableName: "BraveShared", bundle: .module, value: "User cancelled", comment: "Error message if the payment workflow is canceled by the user")
    static let invalidDetailsMessage = NSLocalizedString("invalidDetailsMessage", tableName: "BraveShared", bundle: .module, value: "Invalid details in payment request", comment: "Error message if details don't have the right type or values")
    static let clientErrorMessage = NSLocalizedString("clientErrorMessage", tableName: "BraveShared", bundle: .module, value: "Client error", comment: "Client is in an invalid state which caused the error")
}

public extension Strings {
    static let urlRedirectsSettings =
    ...
    static let redditRedirectFooter =
...
public extension Strings {
    enum Hotkey {
        ...
        public static let showShieldsTitle = NSLocalizedString("showShieldsTitle", bundle: .module, value: "Open Browser Shields", comment: "Label to display in the Discoverability overlay for keyboard shortcuts which is for Showing Browser Shields")
...
public extension Strings {
    static let contentFiltering = NSLocalizedString("ContentFiltering", tableName: "BraveShared", bundle: .module, value: "Content Filtering", comment: "A title to the content filtering page under global shield settings and the title on the Content filtering page")
    static let blockMobileAnnoyances = NSLocalizedString("blockMobileAnnoyances", tableName: "BraveShared", bundle: .module, value: "Block 'Switch to App' Notices", comment: "A title for setting which blocks 'switch to app' popups")
    static let contentFilteringDescription = NSLocalizedString("ContentFilteringDescription", tableName: "BraveShared", bundle: .module, value: "Enable custom filters that block regional and language-specific trackers and Annoyances", comment: "A description of the content filtering page.")
    static let defaultFilterLists = NSLocalizedString("DefaultFilterLists", tableName: "BraveShared", bundle: .module, value: "Default Filter Lists", comment: "A section title that contains default (predefined) filter lists a user can enable/diable.")
    static let filterListsDescription = NSLocalizedString("FilterListsDescription", tableName: "BraveShared", bundle: .module, value: "Additional popular community lists. Note that enabling too many filters will degrade browsing speeds.", comment: "A description on the content filtering screen for the filter lists section.")
    static let addCustomFilterList = NSLocalizedString("AddCustomFilterList", tableName: "BraveShared", bundle: .module, value: "Add Custom Filter List", comment: "A title within a cell where a user can navigate to an add screen.")
    static let customFilterList = NSLocalizedString("CustomFilterList", tableName: "BraveShared", bundle: .module, value: "Custom Filter List", comment: "Title for the custom filter list add screen found in the navigation bar.")
    static let customFilterLists = NSLocalizedString("CustomFilterLists", tableName: "BraveShared", bundle: .module, value: "Custom Filter Lists", comment: "A title for a section that contains all custom filter lists")
    static let customFilterListURL = NSLocalizedString("CustomFilterListsURL", tableName: "BraveShared", bundle: .module, value: "Custom Filter List URL", comment: "A section heading above a cell that allows you to enter a filter list URL.")
    static let addCustomFilterListDescription = NSLocalizedString("AddCustomFilterListDescription", tableName: "BraveShared", bundle: .module, value: "Add additional lists created and maintained by your trusted community.", comment: "A description of a section in a list that allows you to add custom filter lists found in the footer of the add custom url screen")
    static let addCustomFilterListWarning = NSLocalizedString("AddCustomFilterListWarning", tableName: "BraveShared", bundle: .module, value: "**Only subscribe to lists from entities you trust**. Your browser will periodically check for list updates from the URL you enter.", comment: "Warning text found in the footer of the add custom filter list url screen.")
    static let filterListsLastUpdated = NSLocalizedString("FilterListsLastUpdatedLabel", tableName: "BraveShared", bundle: .module, value: "Last updated %@", comment: "A label that shows when the filter list was last updated. Do not translate the '%@' placeholder. The %@ will be replaced with a relative date. For example, '5 minutes ago' or '1 hour ago'. So the full string will read something like 'Last updated 5 minutes ago'.")
    static let filterListsDownloadPending = NSLocalizedString("FilterListsDownloadPending", tableName: "BraveShared", bundle: .module, value: "Pending download", comment: "If a filter list is not yet downloaded this label shows up instead of a last download date, signifying that the download is still pending.")
    static let filterListsEnterFilterListURL = NSLocalizedString("FilterListsEnterFilterListURL", tableName: "BraveShared", bundle: .module, value: "Enter filter list URL", comment: "This is a placeholder for an input field that takes a custom filter list URL.")
    static let filterListsAdd = NSLocalizedString("FilterListsAdd", tableName: "BraveShared", bundle: .module, value: "Add", comment: "This is a button on the top navigation that takes the user to an add custom filter list url to the list")
    static let filterListsEdit = NSLocalizedString("FilterListsEdit", tableName: "BraveShared", bundle: .module, value: "Edit", comment: "This is a button on the top navigation that takes the user to an add custom filter list url to the list")
    static let filterListURLTextFieldPlaceholder = NSLocalizedString("FilterListURLTextFieldPlaceholder", tableName: "BraveShared", bundle: .module, value: "Enter filter list URL here ", comment: "This is a placeholder for the custom filter list url text field where a user may enter a custom filter list URL")
    static let filterListsDownloadFailed = NSLocalizedString("FilterListsDownloadFailed", tableName: "BraveShared", bundle: .module, value: "Download failed", comment: "This is a generic error message when downloading a filter list fails.")
    static let filterListAddInvalidURLError = NSLocalizedString("FilterListAddInvalidURLError", tableName: "BraveShared", bundle: .module, value: "The URL entered is invalid", comment: "This is an error message when a user tries to enter an invalid URL into the custom filter list URL text field.")
    static let filterListAddOnlyHTTPSAllowedError = NSLocalizedString("FilterListAddOnlyHTTPSAllowedError", tableName: "BraveShared", bundle: .module, value: "Only secure (https) URLs are allowed for custom filter lists", comment: "This is an error message when a user tries to enter a non-https scheme URL into the 'add custom filter list URL' input field")
...
public extension Strings {
    enum Menu {
        public static let scriptManagement = NSLocalizedString("ScriptManagement", tableName: "BraveShared", bundle: .module, value: "Script", comment: "ScriptManagement")

        public static let myBookmarks = NSLocalizedString("MyBookmarks", tableName: "BraveShared", bundle: .module, value: "Bookmark", comment: "MyBookmarks")

        public static let myDownloads = NSLocalizedString("MyDownloads", tableName: "BraveShared", bundle: .module, value: "Download", comment: "MyDownloads")
        
        
        public static let bookmark = NSLocalizedString("Bookmark", tableName: "BraveShared", bundle: .module, value: "Bookmark", comment: "Add Bookmark")
        public static let aiTxt = NSLocalizedString("AiTxt", tableName: "BraveShared", bundle: .module, value: "AiTxt", comment: "AI Interpretation")
        public static let readMode = NSLocalizedString("ReadMode", tableName: "BraveShared", bundle: .module, value: "Read Mode", comment: "Read Mode")
        public static let translate = NSLocalizedString("Translate", tableName: "BraveShared", bundle: .module, value: "Translate", comment: "Translate")
        public static let refresh = NSLocalizedString("Refresh", tableName: "BraveShared", bundle: .module, value: "Refresh", comment: "Refresh")
        public static let nightMode = NSLocalizedString("NightMode", tableName: "BraveShared", bundle: .module, value: "NightMode", comment: "Night Mode")
        public static let search = NSLocalizedString("Search", tableName: "BraveShared", bundle: .module, value: "Search", comment: "Search Page")
        
        public static let adBlock = NSLocalizedString("AdBlock", tableName: "BraveShared", bundle: .module, value: "AdBlock", comment: "AdBlock")
        public static let desktop = NSLocalizedString("Desktop", tableName: "BraveShared", bundle: .module, value: "Desktop", comment: "Desktop Mode")
        public static let pdf = NSLocalizedString("PDF", tableName: "BraveShared", bundle: .module, value: "PDF", comment: "PDF")
        public static let zoom = NSLocalizedString("Zoom", tableName: "BraveShared", bundle: .module, value: "Zoom", comment: "Zoom")
        public static let certificate = NSLocalizedString("Certificate", tableName: "BraveShared", bundle: .module, value: "Certificate", comment: "Certificate")
     
        public static let playlist = NSLocalizedString("Playlist", tableName: "BraveShared", bundle: .module, value: "Playlist", comment: "Playlist")
        public static let devTool = NSLocalizedString("DevTool", tableName: "BraveShared", bundle: .module, value: "devTool", comment: "devTool")
    }

    enum Home {
        public static let sendToHomePageFavorites = NSLocalizedString("SendToHomePageFavorites", tableName: "BraveShared", bundle: .module, value: "Send to Home Page Favorites", comment: "Title for sending to home page favorites")
        
        public static let homePage = NSLocalizedString("HomePage", tableName: "BraveShared", bundle: .module, value: "Home Page", comment: "主页")

        public static let shopHelper = NSLocalizedString("ShopHelper", tableName: "BraveShared", bundle: .module, value: "shopHelper", comment: "购物工具")

        public static let premium = NSLocalizedString("Premium", tableName: "BraveShared", bundle: .module, value: "Premium", comment: "精选")

        public static let translate = NSLocalizedString("Translate", tableName: "BraveShared", bundle: .module, value: "Translate", comment: "翻译")
        public static let scriptPrim = NSLocalizedString("ScriptPrim", tableName: "BraveShared", bundle: .module, value: "Scripts", comment: "脚本推荐")
    }

    enum Other {
        public static let readEnable = NSLocalizedString("ReadEnable", tableName: "BraveShared", bundle: .module, value: "The current webpage reading mode is not applicable.", comment: "脚本推荐")

        public static let alertTitle = NSLocalizedString("AlertTitle", tableName: "BraveShared", bundle: .module, value: "Alert", comment: "Alert title")
        public static let copySuccessMessage = NSLocalizedString("CopySuccessMessage", tableName: "BraveShared", bundle: .module, value: "Copy success", comment: "Copy success message")
        
        public static let selectPhoto = NSLocalizedString("SelectPhoto", tableName: "BraveShared", bundle: .module, value: "Select Photo", comment: "Select Photo")
        
        public static let noQrcode = NSLocalizedString("NoQrcode", tableName: "BraveShared", bundle: .module, value: "Can not find Qrcode", comment: "Can not find Qrcode")
        
        public static let duetolegal = NSLocalizedString("Duetolegal", tableName: "BraveShared", bundle: .module, value: "Due to legal requirements, ad blocking is not allowed on this website.", comment: "Due to legal requirements, ad blocking is not allowed on this website.")
        public static let adBlockandPrivacyProtection = NSLocalizedString("AdBlockandPrivacyProtection", tableName: "BraveShared", bundle: .module, value: "Ad Block and Privacy Protection", comment: "Ad Block and Privacy Protection")
        ...
        public static let nickname = NSLocalizedString(
          "Nickname", tableName: "BraveShared", bundle: .module,
          value: "Nickname",
          comment: "nickname"
        )
        public static let contactUs = NSLocalizedString(
          "ContactUs", tableName: "BraveShared", bundle: .module,
          value: "Contact Us",
          comment: "Contact Us"
        )
        public static let updateLogandFeedback = NSLocalizedString(
          "UpdateLogandFeedback", tableName: "BraveShared", bundle: .module,
          value: "Update Log and Feedback",
          comment: "Update Log and Feedback"
        )
